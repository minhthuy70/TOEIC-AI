...
\restrict wlhZPVVUlR5jt35wY9NV2mQ7Eh7kAkA2hs5TH1obNyUGweCleddHe12EhVvV3xc
...
CREATE TABLE public."UserProfile" (
    ...
    address text,
    bio text,
    "studyNotification" boolean DEFAULT true NOT NULL,
    "srsNotification" boolean DEFAULT true NOT NULL,
    "autoPronunciation" boolean DEFAULT false NOT NULL,
...
--
-- Name: grammar_categories; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.grammar_categories OWNER TO postgres;

--
-- Name: COLUMN grammar_categories.stage; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.grammar_categories.stage IS 'Chặng ngữ pháp: 1=0-300, 2=300-500, 3=500-650, 4=650-800, 5=800-990';


--
-- Name: grammar_categories_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.grammar_categories_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.grammar_categories_id_seq OWNER TO postgres;

--
-- Name: grammar_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.grammar_categories_id_seq OWNED BY public.grammar_categories.id;


--
-- Name: grammar_lessons; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.grammar_lessons OWNER TO postgres;

--
-- Name: grammar_lessons_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.grammar_lessons_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.grammar_lessons_id_seq OWNER TO postgres;

--
-- Name: grammar_lessons_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.grammar_lessons_id_seq OWNED BY public.grammar_lessons.id;


--
-- Name: listening_lessons; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.listening_lessons OWNER TO postgres;

--
-- Name: listening_lessons_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.listening_lessons_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.listening_lessons_id_seq OWNER TO postgres;

--
-- Name: listening_lessons_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.listening_lessons_id_seq OWNED BY public.listening_lessons.id;
...
--
-- Name: reading_lessons; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.reading_lessons OWNER TO postgres;

--
-- Name: reading_lessons_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.reading_lessons_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.reading_lessons_id_seq OWNER TO postgres;

--
-- Name: reading_lessons_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.reading_lessons_id_seq OWNED BY public.reading_lessons.id;
...
--
-- Name: user_listening_progress; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.user_listening_progress OWNER TO postgres;

--
-- Name: user_listening_progress_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.user_listening_progress_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.user_listening_progress_id_seq OWNER TO postgres;

--
-- Name: user_listening_progress_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.user_listening_progress_id_seq OWNED BY public.user_listening_progress.id;


--
-- Name: user_reading_progress; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: user_reading_progress_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.user_reading_progress_id_seq OWNER TO postgres;

--
-- Name: user_reading_progress_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: grammar_categories id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.grammar_categories ALTER COLUMN id SET DEFAULT nextval('public.grammar_categories_id_seq'::regclass);


--
-- Name: grammar_lessons id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.grammar_lessons ALTER COLUMN id SET DEFAULT nextval('public.grammar_lessons_id_seq'::regclass);


--
-- Name: listening_lessons id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.listening_lessons ALTER COLUMN id SET DEFAULT nextval('public.listening_lessons_id_seq'::regclass);
...
--
-- Name: reading_lessons id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reading_lessons ALTER COLUMN id SET DEFAULT nextval('public.reading_lessons_id_seq'::regclass);
...
--
-- Name: user_listening_progress id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_listening_progress ALTER COLUMN id SET DEFAULT nextval('public.user_listening_progress_id_seq'::regclass);


--
-- Name: user_reading_progress id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
2	Nguyen Minh Thuy	TUVUNG1@gmail.com	$2b$10$C93MfC22.2.N/jjt08ygJOGUP8o927PBYzexx9.0KsGhSOUb4O8hW	2026-07-24 16:26:45.552
\.
...
COPY public."UserProfile" (id, "currentScore", "targetScore", "examDate", "dailyStudyTime", "firstLoginCompleted", "userId", "createdAt", "updatedAt", avatar, phone, birthday, gender, address, bio, "studyNotification", "srsNotification", "autoPronunciation", "darkMode") FROM stdin;
1	100	648	2030-10-11 00:00:00	120	t	1	2026-07-24 06:16:24.669	2026-07-24 06:16:55.605	\N	\N	\N	\N	\N	\N	t	t	f	t
3	450	950	\N	120	t	2	2026-07-24 16:26:45.552	2026-08-01 07:46:46.647	\N	0901234567	\N	Nam	TP.HCM	Đang học TOEIC cùng BELLA	t	t	f	f
\.
...
--
-- Data for Name: grammar_categories; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.grammar_categories (id, name, description, display_order, created_at, updated_at, stage) FROM stdin;
1	Cấu tạo câu	Nền tảng về thành phần câu và các cấu trúc câu tiếng Anh cơ bản.	1	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
2	Từ loại	Nhận biết và sử dụng các loại từ cơ bản trong tiếng Anh.	2	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
3	Danh từ	Danh từ số ít, số nhiều, đếm được, không đếm được và danh từ ghép.	3	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
4	Đại từ	Các loại đại từ và cách sử dụng trong câu.	4	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
5	Động từ	Động từ thường, động từ be, have, do, nội động từ và ngoại động từ.	5	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
6	Tính từ	Vị trí và cách sử dụng tính từ trong câu.	6	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
7	Trạng từ	Các loại trạng từ và vị trí của trạng từ trong câu.	7	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
8	Mạo từ	Cách sử dụng a, an, the và trường hợp không dùng mạo từ.	8	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
9	Giới từ cơ bản	Các giới từ cơ bản như in, on, at, from, to, for, with, by, about, of.	9	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
10	Liên từ cơ bản	Các liên từ cơ bản như and, but, or, so, because, although.	10	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
11	Thì hiện tại đơn	Cấu trúc, cách dùng, phủ định, nghi vấn và dấu hiệu nhận biết.	11	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
12	Thì hiện tại tiếp diễn	Cấu trúc be + V-ing, cách dùng và dấu hiệu nhận biết.	12	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
13	Thì quá khứ đơn	Cách sử dụng V-ed, động từ bất quy tắc, did và dấu hiệu nhận biết.	13	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
14	Thì tương lai cơ bản	Will và be going to cùng các cách sử dụng cơ bản.	14	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
15	So sánh cơ bản	So sánh hơn, so sánh nhất và cấu trúc as...as.	15	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
16	Từ chỉ số lượng	Some, any, much, many, few, little, a lot of và các từ chỉ lượng cơ bản.	16	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	1
17	Hệ thống 12 thì	Hệ thống đầy đủ các thì hiện tại, quá khứ và tương lai.	1	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
18	Sự phối hợp các thì	Cách phối hợp thì và các dấu hiệu thời gian trong câu.	2	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
19	Modal Verbs	Can, could, may, might, must, should, will, would và các động từ khuyết thiếu khác.	3	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
20	Gerund	Cách sử dụng V-ing làm chủ ngữ, tân ngữ và sau giới từ.	4	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
21	Infinitive	To-infinitive, bare infinitive và các cấu trúc động từ đi với infinitive.	5	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
22	Gerund và Infinitive	Phân biệt các động từ đi với gerund và infinitive.	6	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
23	Passive Voice	Câu bị động ở các thì và với modal verbs.	7	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
24	Câu hỏi	Yes/No questions, Wh-questions, subject questions, object questions và tag questions.	8	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
25	Relative Clauses	Mệnh đề quan hệ với who, whom, which, that, whose, where và when.	9	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
26	Reduced Relative Clauses	Rút gọn mệnh đề quan hệ bằng V-ing, V3/ed và to-infinitive.	10	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
27	Liên từ nâng cao	Các liên từ chỉ nguyên nhân, thời gian, điều kiện, tương phản và mục đích.	11	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
28	Giới từ nâng cao	Các giới từ và cụm giới từ thường gặp trong TOEIC.	12	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
29	Adjective và Adverb	Phân biệt tính từ và trạng từ cùng các trường hợp dễ nhầm.	13	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
30	Word Forms	Nhận biết và biến đổi noun, verb, adjective và adverb.	14	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
31	Comparisons	Các cấu trúc so sánh nâng cao.	15	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
32	Quantity	Each, every, either, neither, both, all, none, another, other và others.	16	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	2
33	Noun Clauses	Mệnh đề danh từ với that, whether, if và wh-clauses.	1	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
34	Adverbial Clauses	Mệnh đề trạng ngữ chỉ thời gian, nguyên nhân, điều kiện, nhượng bộ, mục đích và kết quả.	2	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
35	Conditionals	Câu điều kiện loại 0, 1, 2, 3 và mixed conditionals.	3	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
36	Wish	Cấu trúc wish với hiện tại, quá khứ và would.	4	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
37	Causative	Cấu trúc have, get, make, let và help.	5	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
38	Participles	Present participle, past participle và perfect participle.	6	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
39	Participle Clauses	Rút gọn mệnh đề bằng participle.	7	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
40	Appositives	Danh từ và cụm danh từ đồng vị.	8	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
41	Parallel Structure	Cấu trúc song song với các liên từ và cấu trúc tương quan.	9	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
42	Subject-Verb Agreement	Quy tắc hòa hợp giữa chủ ngữ và động từ.	10	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
43	Articles nâng cao	Cách sử dụng mạo từ trong các trường hợp đặc biệt.	11	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
44	Determiners	Each, every, either, neither, enough, sufficient và các từ hạn định.	12	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
45	Quantifiers nâng cao	Phân biệt few, a few, little, a little, fewer, less, number và amount.	13	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
46	Preposition Collocations	Các cụm từ cố định đi với giới từ thường gặp trong TOEIC.	14	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
47	Verb Patterns	Các mẫu cấu trúc động từ thường gặp.	15	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
48	Phrasal Verbs	Các cụm động từ thường xuất hiện trong tiếng Anh công sở và TOEIC.	16	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	3
49	Advanced Passive	Các cấu trúc bị động nâng cao và passive reporting.	1	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
50	Reporting Verbs	Say, tell, report, claim, announce, suggest, recommend, advise và các động từ tường thuật.	2	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
51	Reported Speech	Câu tường thuật và sự thay đổi thì, đại từ và trạng từ thời gian.	3	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
52	Subjunctive	Cấu trúc giả định sau recommend, suggest, insist, demand và require.	4	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
53	Inversion	Đảo ngữ với trạng từ phủ định và các cấu trúc đặc biệt.	5	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
54	Emphasis	Các cấu trúc nhấn mạnh bằng do/does/did, cleft sentences và pseudo-cleft.	6	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
55	Advanced Relative Clauses	Mệnh đề quan hệ nâng cao và các trường hợp đặc biệt.	7	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
56	Advanced Conditionals	Đảo ngữ trong câu điều kiện và các cấu trúc điều kiện nâng cao.	8	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
57	Mixed Conditionals	Câu điều kiện hỗn hợp giữa quá khứ và hiện tại.	9	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
58	Ellipsis	Lược bỏ các thành phần lặp lại trong câu.	10	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
59	Fronting	Đưa thành phần câu lên đầu để nhấn mạnh.	11	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
60	Advanced Comparison	Các cấu trúc so sánh nâng cao và các trạng từ bổ nghĩa cho so sánh.	12	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
61	Advanced Conjunctions	Provided that, as long as, in case, even if, so that và các liên từ nâng cao.	13	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
62	Complex Prepositions	Các cụm giới từ trang trọng thường gặp trong văn phong học thuật và công việc.	14	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
63	Formal English	Các cấu trúc tiếng Anh trang trọng thường xuất hiện trong văn bản công việc.	15	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	4
64	Fine Grammar Distinctions	Phân biệt các cấu trúc và từ ngữ có cách dùng gần giống nhau.	1	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
65	Advanced Verb Complementation	Phân biệt các mẫu động từ đi với to V, V-ing, O + to V, O + V và mệnh đề that.	2	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
66	Subtle Tense Distinctions	Phân biệt sắc thái sử dụng giữa các thì gần giống nhau.	3	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
67	Advanced Article Usage	Cách dùng mạo từ trong các trường hợp tinh vi và văn phong nâng cao.	4	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
68	Advanced Noun Structures	Cấu trúc danh từ ghép, sở hữu cách, of-phrase và các cấu trúc danh từ phức tạp.	5	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
69	Nominalization	Chuyển đổi động từ và tính từ thành danh từ trong văn phong học thuật và công việc.	6	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
70	Dangling Modifiers	Nhận biết và sửa lỗi cụm bổ nghĩa không có chủ thể phù hợp.	7	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
71	Modifier Placement	Vị trí của tính từ, trạng từ và các cụm bổ nghĩa.	8	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
72	Advanced Parallelism	Các cấu trúc song song nâng cao trong câu phức tạp.	9	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
73	Advanced Agreement	Các trường hợp hòa hợp chủ ngữ - động từ phức tạp.	10	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
74	Formal Inversion	Các cấu trúc đảo ngữ trang trọng và nâng cao.	11	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
75	Advanced Emphasis	Cleft, pseudo-cleft, fronting và inversion để nhấn mạnh.	12	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
76	Concessive Structures	Although, despite, in spite of, regardless of, notwithstanding và các cấu trúc nhượng bộ.	13	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
77	Advanced Result Structures	So...that, such...that, too...to và enough...to.	14	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
78	Advanced Purpose	Các cấu trúc chỉ mục đích nâng cao.	15	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
79	Advanced Cause and Reason	Các cấu trúc chỉ nguyên nhân và lý do nâng cao.	16	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
80	Advanced Discourse Grammar	Các từ và cấu trúc liên kết như however, therefore, moreover, nevertheless và consequently.	17	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
81	Punctuation Grammar	Dấu phẩy, chấm phẩy, dấu hai chấm và các quy tắc dấu câu liên quan đến ngữ pháp.	18	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
82	Business English	Các cấu trúc ngữ pháp thường gặp trong email, thông báo, báo cáo và văn bản công việc.	19	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
83	TOEIC Grammar Traps	Các dạng bẫy ngữ pháp thường gặp trong Part 5 và Part 6.	20	2026-08-08 17:48:19.226059	2026-08-08 17:48:19.226059	5
\.


--
-- Data for Name: grammar_lessons; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.grammar_lessons (id, category_id, title, content, display_order, created_at, updated_at, test_id) FROM stdin;
92	1	Trạng ngữ (Adverbial)	\n# Trạng ngữ (Adverbial)\n\n## 1. Khái niệm\n\nAdverbial (A) là trạng ngữ, cung cấp thêm thông tin về:\n\n- thời gian\n- địa điểm\n- cách thức\n- tần suất\n- nguyên nhân\n\n## 2. Trạng ngữ thời gian\n\nThe manager arrived yesterday.\n\nyesterday = thời gian\n\n## 3. Trạng ngữ địa điểm\n\nShe works in the office.\n\nin the office = địa điểm\n\n## 4. Trạng ngữ cách thức\n\nHe works carefully.\n\ncarefully = cách thức\n\n## 5. Trạng ngữ có thể đứng ở nhiều vị trí\n\nYesterday, the manager arrived.\n\nThe manager arrived yesterday.\n\n## 6. Mẹo TOEIC\n\nTrạng ngữ thường có thể được di chuyển hoặc loại bỏ mà câu vẫn giữ được cấu trúc chính.\n\nVí dụ:\n\nThe manager works.\n\nThe manager works in the office.\n\n	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
94	1	Cấu trúc S + V + O	\n# Cấu trúc S + V + O\n\n## 1. Công thức\n\nS + V + O\n\nS = Subject\nV = Verb\nO = Object\n\n## 2. Ví dụ\n\nShe reads the report.\n\nShe = S\nreads = V\nthe report = O\n\nThe manager checks the documents.\n\nThe manager = S\nchecks = V\nthe documents = O\n\n## 3. Đặc điểm\n\nĐộng từ trong cấu trúc này thường là ngoại động từ, cần có Object để hoàn chỉnh ý nghĩa.\n\n## 4. Mẹo TOEIC\n\nNếu sau động từ cần một đối tượng chịu tác động, hãy kiểm tra cấu trúc S + V + O.\n\n	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
95	1	Cấu trúc S + V + C	\n# Cấu trúc S + V + C\n\n## 1. Công thức\n\nS + V + C\n\nC = Complement\n\n## 2. Ví dụ\n\nShe is a manager.\n\nShe = S\nis = V\na manager = C\n\nThe office is large.\n\nThe office = S\nis = V\nlarge = C\n\n## 3. Động từ thường gặp\n\nCấu trúc này thường xuất hiện với linking verbs:\n\n- be\n- become\n- seem\n- look\n- feel\n- sound\n\nVí dụ:\n\nThe plan seems effective.\n\n## 4. Phân biệt\n\nS + V + O:\n\nShe reads a report.\n\nS + V + C:\n\nShe is a manager.\n\n	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
96	1	Cấu trúc S + V + O + O	\n# Cấu trúc S + V + O + O\n\n## 1. Công thức\n\nS + V + O + O\n\nCó hai tân ngữ:\n\n- Indirect Object (IO): tân ngữ gián tiếp\n- Direct Object (DO): tân ngữ trực tiếp\n\n## 2. Ví dụ\n\nShe gave me a report.\n\nShe = S\ngave = V\nme = IO\na report = DO\n\n## 3. Một số động từ thường gặp\n\n- give\n- send\n- show\n- tell\n- offer\n- lend\n- buy\n\nVí dụ:\n\nThe manager sent me an email.\n\n## 4. Cách hiểu\n\nNgười nhận = tân ngữ gián tiếp.\n\nVật được trao/gửi = tân ngữ trực tiếp.\n\n	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
97	1	Cấu trúc S + V + O + C	\n# Cấu trúc S + V + O + C\n\n## 1. Công thức\n\nS + V + O + C\n\nC = bổ ngữ cho Object.\n\n## 2. Ví dụ\n\nThey elected him president.\n\nThey = S\nelected = V\nhim = O\npresident = C\n\n## 3. Một số động từ thường gặp\n\n- make\n- call\n- name\n- elect\n- consider\n- find\n\nVí dụ:\n\nThe company appointed John manager.\n\nJohn = Object\nmanager = Complement\n\n## 4. Phân biệt với S + V + O + O\n\nS + V + O + O:\n\nShe gave me a book.\n\n"me" và "a book" đều là Object.\n\nS + V + O + C:\n\nThey made him manager.\n\n"him" = Object\n"manager" = Complement.\n\n	11	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
98	1	Câu khẳng định	\n# Câu khẳng định\n\n## 1. Khái niệm\n\nCâu khẳng định dùng để đưa ra một thông tin hoặc khẳng định một sự việc.\n\n## 2. Cấu trúc cơ bản\n\nS + V + ...\n\nVí dụ:\n\nShe works at the company.\n\nThe manager checks the report.\n\n## 3. Với động từ TO BE\n\nS + be + ...\n\nVí dụ:\n\nShe is a manager.\n\nThey are busy.\n\n## 4. Với động từ thường\n\nS + V + ...\n\nVí dụ:\n\nHe works every day.\n\nShe studies English.\n\n## 5. Mẹo TOEIC\n\nHãy xác định chủ ngữ và động từ trước, sau đó mới xác định các thành phần còn lại.\n\n	12	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
99	1	Câu phủ định	\n# Câu phủ định\n\n## 1. Với động từ TO BE\n\nS + be + not + ...\n\nVí dụ:\n\nShe is not busy.\n\nThey are not ready.\n\n## 2. Với động từ thường\n\nS + do/does + not + V nguyên mẫu\n\nVí dụ:\n\nShe does not work here.\n\nThey do not work here.\n\n## 3. Với quá khứ đơn\n\nS + did not + V nguyên mẫu\n\nVí dụ:\n\nHe did not attend the meeting.\n\n## 4. Lưu ý\n\nSau do, does hoặc did, động từ chính phải trở về dạng nguyên mẫu.\n\nSai:\n\nShe does not works here.\n\nĐúng:\n\nShe does not work here.\n\n## 5. Mẹo TOEIC\n\nĐây là một bẫy thường gặp trong câu hỏi ngữ pháp: sau does/did không chia động từ chính.\n\n	13	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
100	1	Câu nghi vấn	\n# Câu nghi vấn\n\n## 1. Câu hỏi Yes/No\n\nVới TO BE:\n\nBe + S + ...?\n\nVí dụ:\n\nIs she a manager?\n\nAre they ready?\n\nVới động từ thường:\n\nDo/Does + S + V...?\n\nVí dụ:\n\nDoes she work here?\n\nDo they need help?\n\n## 2. Câu hỏi WH\n\nTừ hỏi thường gặp:\n\n- What\n- Where\n- When\n- Why\n- Who\n- How\n\nVí dụ:\n\nWhere does she work?\n\nWhen does the meeting start?\n\n## 3. Lưu ý\n\nSau do/does/did, động từ chính dùng dạng nguyên mẫu.\n\nDoes he works here? ❌\n\nDoes he work here? ✅\n\n## 4. Mẹo TOEIC\n\nKhi gặp câu hỏi, xác định:\n\n1. Từ để hỏi\n2. Trợ động từ\n3. Chủ ngữ\n4. Động từ chính\n\n	14	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
101	1	Câu mệnh lệnh	\n# Câu mệnh lệnh\n\n## 1. Khái niệm\n\nCâu mệnh lệnh dùng để yêu cầu, hướng dẫn hoặc ra lệnh cho người khác thực hiện một hành động.\n\n## 2. Công thức\n\nV nguyên mẫu + ...\n\nVí dụ:\n\nOpen the door.\n\nClose the window.\n\nCheck the report.\n\n## 3. Câu mệnh lệnh phủ định\n\nDo not + V nguyên mẫu\n\nVí dụ:\n\nDo not open the door.\n\nDon't forget the meeting.\n\n## 4. Mệnh lệnh lịch sự\n\nPlease + V nguyên mẫu.\n\nVí dụ:\n\nPlease send the report.\n\nPlease check this document.\n\n## 5. Mẹo TOEIC\n\nCâu mệnh lệnh thường không có chủ ngữ được viết ra. Chủ ngữ ngầm hiểu là "you".\n\n	15	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
87	1	Các thành phần cơ bản của câu	\n# Các thành phần cơ bản của câu\n\n## 1. Tổng quan\n\nMột câu tiếng Anh thường được tạo thành từ nhiều thành phần khác nhau. Những thành phần quan trọng nhất gồm:\n\n- Subject (S): Chủ ngữ\n- Verb (V): Động từ\n- Object (O): Tân ngữ\n- Complement (C): Bổ ngữ\n- Adverbial (A): Trạng ngữ\n\nCác thành phần này kết hợp với nhau để tạo thành những cấu trúc câu khác nhau.\n\n## 2. Chủ ngữ – Subject\n\nChủ ngữ là người, vật hoặc sự việc thực hiện hành động hoặc được nói đến trong câu.\n\nVí dụ:\n\nThe manager works hard.\n→ Người quản lý làm việc chăm chỉ.\n\nThe employees are busy.\n→ Các nhân viên đang bận.\n\n## 3. Động từ – Verb\n\nĐộng từ diễn tả hành động hoặc trạng thái.\n\nVí dụ:\n\nShe works every day.\n→ Cô ấy làm việc mỗi ngày.\n\nThe office is large.\n→ Văn phòng rộng.\n\n## 4. Tân ngữ – Object\n\nTân ngữ là đối tượng chịu tác động của hành động.\n\nVí dụ:\n\nShe reads the report.\n\nShe = Subject\nreads = Verb\nthe report = Object\n\n## 5. Bổ ngữ – Complement\n\nBổ ngữ cung cấp thông tin bổ sung cho chủ ngữ hoặc tân ngữ.\n\nVí dụ:\n\nShe is a manager.\n\na manager = Complement\n\n## 6. Trạng ngữ – Adverbial\n\nTrạng ngữ cung cấp thông tin về thời gian, địa điểm, cách thức hoặc nguyên nhân.\n\nVí dụ:\n\nHe works in the office.\n\nin the office = Adverbial\n\n## 7. Mẹo TOEIC\n\nTrong Part 5, hãy xác định trước:\n\n1. Chủ ngữ ở đâu?\n2. Động từ chính ở đâu?\n3. Sau động từ có cần Object hoặc Complement không?\n\nNắm được thành phần câu sẽ giúp xác định nhanh cấu trúc của câu.\n	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
88	1	Chủ ngữ (Subject)	\n# Chủ ngữ (Subject)\n\n## 1. Khái niệm\n\nSubject (S) là chủ ngữ của câu. Chủ ngữ thường là người, vật hoặc sự việc thực hiện hành động hoặc được mô tả.\n\n## 2. Vị trí\n\nChủ ngữ thường đứng trước động từ.\n\nCấu trúc:\n\nS + V\n\nVí dụ:\n\nThe manager works.\n→ Người quản lý làm việc.\n\nThe employees work.\n→ Các nhân viên làm việc.\n\n## 3. Chủ ngữ có thể là\n\n### Danh từ\n\nThe company is successful.\n\n### Đại từ\n\nShe works here.\n\n### Cụm danh từ\n\nThe new manager works here.\n\n## 4. Mẹo TOEIC\n\nKhi gặp câu Part 5, hãy tìm chủ ngữ trước rồi xác định động từ cần chia theo chủ ngữ.\n\nVí dụ:\n\nThe manager ___ every day.\n\nA. work\nB. works\nC. working\nD. worked\n\nĐáp án: B. works\n\nVì chủ ngữ "The manager" là số ít.\n	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
89	1	Động từ (Verb)	\n# Động từ (Verb)\n\n## 1. Khái niệm\n\nVerb (V) là động từ. Động từ diễn tả hành động hoặc trạng thái của chủ thể.\n\nVí dụ:\n\nThe employee works.\n\nShe studies English.\n\nThe company is successful.\n\n## 2. Động từ hành động\n\nCác động từ như:\n\n- work\n- study\n- open\n- close\n- send\n- receive\n\nVí dụ:\n\nThe employee sends an email.\n\n## 3. Động từ trạng thái\n\nMột số động từ mô tả trạng thái:\n\n- be\n- know\n- like\n- need\n- want\n\nVí dụ:\n\nShe knows the answer.\n\n## 4. Động từ trong câu\n\nCâu tiếng Anh hoàn chỉnh thường cần có động từ chính.\n\nVí dụ:\n\nThe manager works here.\n\nS = The manager\nV = works\n\n## 5. Mẹo TOEIC\n\nNếu câu đã có chủ ngữ nhưng thiếu động từ chính, đáp án thường cần một dạng động từ phù hợp.\n\n	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
90	1	Tân ngữ (Object)	\n# Tân ngữ (Object)\n\n## 1. Khái niệm\n\nObject (O) là tân ngữ, thường là người hoặc vật chịu tác động của hành động.\n\nVí dụ:\n\nShe reads the report.\n\nShe = Subject\nreads = Verb\nthe report = Object\n\n## 2. Vị trí\n\nTân ngữ thường đứng sau động từ ngoại động từ.\n\nCấu trúc:\n\nS + V + O\n\nVí dụ:\n\nThe manager checks the document.\n\nThe manager = S\nchecks = V\nthe document = O\n\n## 3. Tân ngữ có thể là\n\nDanh từ:\n\nShe opened the door.\n\nĐại từ:\n\nThe manager called me.\n\nCụm danh từ:\n\nWe received the new report.\n\n## 4. Mẹo TOEIC\n\nNếu sau động từ cần một đối tượng chịu tác động, hãy kiểm tra khả năng xuất hiện của Object.\n\n	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
91	1	Bổ ngữ (Complement)	\n# Bổ ngữ (Complement)\n\n## 1. Khái niệm\n\nComplement (C) là bổ ngữ, cung cấp thông tin cần thiết để hoàn chỉnh ý nghĩa của câu.\n\n## 2. Bổ ngữ cho chủ ngữ\n\nCấu trúc:\n\nS + V + C\n\nVí dụ:\n\nShe is a manager.\n\nShe = S\nis = V\na manager = C\n\n## 3. Bổ ngữ có thể là tính từ\n\nThe office is large.\n\nlarge = Complement\n\n## 4. Bổ ngữ có thể là danh từ\n\nHe is a teacher.\n\na teacher = Complement\n\n## 5. Phân biệt Object và Complement\n\nObject nhận tác động của hành động.\n\nShe reads a book.\n\n"a book" = Object\n\nComplement mô tả hoặc xác định chủ thể.\n\nShe is a teacher.\n\n"a teacher" = Complement\n\n## 6. Mẹo TOEIC\n\nSau các linking verbs như be, become, seem, feel, look, sound, thường có Complement.\n\n	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
93	1	Cấu trúc S + V	\n# Cấu trúc S + V\n\n## 1. Công thức\n\nS + V\n\nTrong đó:\n\nS = Subject\nV = Verb\n\nĐây là cấu trúc câu cơ bản nhất.\n\n## 2. Ví dụ\n\nEmployees work.\n\nEmployees = S\nwork = V\n\nThe manager arrived.\n\nThe manager = S\narrived = V\n\n## 3. Động từ không cần tân ngữ\n\nMột số động từ có thể sử dụng mà không cần Object.\n\nVí dụ:\n\nThe baby sleeps.\n\nThe meeting ended.\n\nThe employees arrived.\n\n## 4. Mẹo TOEIC\n\nNếu động từ không cần Object thì không nên cố thêm một danh từ làm tân ngữ.\n\n	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
102	2	Tổng quan về từ loại	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
103	2	Danh từ (Noun)	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
104	2	Động từ (Verb)	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
105	2	Tính từ (Adjective)	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
106	2	Trạng từ (Adverb)	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
107	2	Đại từ (Pronoun)	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
108	2	Giới từ (Preposition)	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
109	2	Liên từ (Conjunction)	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
110	2	Cách nhận biết từ loại trong câu	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
111	2	Vị trí của các từ loại trong câu	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
112	3	Danh từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
113	3	Danh từ số ít	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
114	3	Danh từ số nhiều	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
115	3	Quy tắc thêm -s và -es	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
116	3	Danh từ bất quy tắc	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
117	3	Danh từ đếm được	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
118	3	Danh từ không đếm được	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
119	3	Phân biệt danh từ đếm được và không đếm được	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
120	3	Danh từ riêng và danh từ chung	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
121	3	Danh từ ghép	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
122	3	Cách thành lập danh từ	\N	11	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
123	4	Đại từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
124	4	Đại từ nhân xưng làm chủ ngữ	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
125	4	Đại từ nhân xưng làm tân ngữ	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
126	4	Tính từ sở hữu	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
127	4	Đại từ sở hữu	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
128	4	Đại từ phản thân	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
129	4	Đại từ chỉ định	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
130	4	Đại từ bất định cơ bản	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
131	4	Phân biệt các loại đại từ	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
132	5	Động từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
133	5	Động từ thường	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
134	5	Động từ Be	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
135	5	Động từ Have	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
136	5	Động từ Do	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
137	5	Nội động từ	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
138	5	Ngoại động từ	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
139	5	Động từ chỉ hành động	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
140	5	Động từ chỉ trạng thái	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
141	5	Động từ chính và trợ động từ	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
142	6	Tính từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
143	6	Tính từ đứng trước danh từ	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
144	6	Tính từ đứng sau động từ Be	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
145	6	Tính từ sau linking verbs	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
146	6	Tính từ chỉ tính chất	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
147	6	Tính từ chỉ cảm xúc	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
148	6	Vị trí của nhiều tính từ	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
149	6	Phân biệt tính từ -ed và -ing	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
150	7	Trạng từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
151	7	Trạng từ chỉ cách thức	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
152	7	Trạng từ chỉ thời gian	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
153	7	Trạng từ chỉ nơi chốn	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
154	7	Trạng từ chỉ tần suất	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
155	7	Trạng từ chỉ mức độ	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
156	7	Vị trí của trạng từ trong câu	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
157	7	Cách thành lập trạng từ	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
158	8	Mạo từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
159	8	Cách sử dụng A	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
160	8	Cách sử dụng AN	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
161	8	Cách sử dụng THE	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
162	8	Phân biệt A và AN	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
163	8	Trường hợp không dùng mạo từ	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
164	8	Mạo từ với danh từ số ít	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
165	8	Mạo từ với danh từ số nhiều	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
166	8	Mạo từ với danh từ không đếm được	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
167	9	Giới từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
168	9	Giới từ IN	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
169	9	Giới từ ON	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
170	9	Giới từ AT	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
171	9	Giới từ FROM	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
172	9	Giới từ TO	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
173	9	Giới từ FOR	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
174	9	Giới từ WITH	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
175	9	Giới từ BY	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
176	9	Giới từ ABOUT	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
177	9	Giới từ OF	\N	11	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
178	9	Phân biệt IN, ON và AT	\N	12	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
179	10	Liên từ là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
180	10	Liên từ AND	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
181	10	Liên từ BUT	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
182	10	Liên từ OR	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
183	10	Liên từ SO	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
184	10	Liên từ BECAUSE	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
185	10	Liên từ ALTHOUGH	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
186	10	Phân biệt các liên từ cơ bản	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
187	11	Cấu trúc thì hiện tại đơn	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
188	11	Cách sử dụng thì hiện tại đơn	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
189	11	Động từ TO BE ở hiện tại đơn	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
190	11	Động từ thường ở hiện tại đơn	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
191	11	Quy tắc thêm S và ES	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
192	11	Quy tắc đổi Y thành IES	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
193	11	Câu phủ định hiện tại đơn	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
194	11	Câu nghi vấn hiện tại đơn	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
195	11	Trạng từ tần suất với hiện tại đơn	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
196	11	Dấu hiệu nhận biết hiện tại đơn	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
197	12	Cấu trúc thì hiện tại tiếp diễn	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
198	12	Cách sử dụng hiện tại tiếp diễn	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
199	12	Cách thêm -ING	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
200	12	Câu phủ định hiện tại tiếp diễn	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
201	12	Câu nghi vấn hiện tại tiếp diễn	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
202	12	Dấu hiệu nhận biết hiện tại tiếp diễn	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
203	12	Động từ không thường dùng ở tiếp diễn	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
204	12	Phân biệt hiện tại đơn và hiện tại tiếp diễn	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
205	13	Cấu trúc thì quá khứ đơn	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
206	13	Cách sử dụng thì quá khứ đơn	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
207	13	Động từ có quy tắc ở quá khứ	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
208	13	Quy tắc thêm -ED	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
209	13	Động từ bất quy tắc	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
210	13	Động từ TO BE ở quá khứ	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
211	13	Câu phủ định quá khứ đơn	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
212	13	Câu nghi vấn quá khứ đơn	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
213	13	Dấu hiệu nhận biết quá khứ đơn	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
214	13	Phân biệt quá khứ đơn và hiện tại đơn	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
215	14	Tương lai với WILL	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
216	14	Cấu trúc WILL + V	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
217	14	Cách sử dụng WILL	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
218	14	Câu phủ định với WILL	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
219	14	Câu nghi vấn với WILL	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
220	14	Tương lai với BE GOING TO	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
221	14	Cấu trúc BE GOING TO + V	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
222	14	Cách sử dụng BE GOING TO	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
223	14	Phân biệt WILL và BE GOING TO	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
224	15	Khái niệm về so sánh	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
225	15	So sánh bằng AS...AS	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
226	15	So sánh hơn với tính từ ngắn	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
227	15	So sánh hơn với tính từ dài	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
228	15	Quy tắc thêm -ER	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
229	15	Cách sử dụng MORE	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
230	15	So sánh nhất với tính từ ngắn	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
231	15	So sánh nhất với tính từ dài	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
232	15	Cách sử dụng MOST	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
233	15	Tính từ so sánh bất quy tắc	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
234	16	Từ chỉ số lượng là gì?	\N	1	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
235	16	SOME	\N	2	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
236	16	ANY	\N	3	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
237	16	MUCH	\N	4	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
238	16	MANY	\N	5	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
239	16	A LOT OF và LOTS OF	\N	6	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
240	16	FEW và A FEW	\N	7	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
241	16	LITTLE và A LITTLE	\N	8	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
242	16	Phân biệt MUCH và MANY	\N	9	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
243	16	Phân biệt FEW và LITTLE	\N	10	2026-08-08 18:01:10.540921	2026-08-08 18:01:10.540921	\N
\.


--
-- Data for Name: listening_lessons; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.listening_lessons (id, title, part, question_group_id, display_order, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: reading_lessons; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.reading_lessons (id, title, part, question_group_id, display_order, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_grammar_progress (id, user_id, lesson_id, completed, score, last_studied, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: user_listening_progress; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_listening_progress (id, user_id, lesson_id, best_score, completed, last_studied, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_reading_progress (id, user_id, lesson_id, best_score, completed, last_studied, created_at, updated_at) FROM stdin;
\.
...
57	2	136	2026-08-03 04:00:55.749	1	2026-08-03 04:30:55.749	2026-08-03 04:00:55.751	LEARNING	1	2026-08-03 04:00:55.749	2026-08-03 04:00:55.751
47	2	65	2026-08-02 15:03:46.134	1	2026-08-02 15:33:46.134	2026-08-02 15:03:46.137	LEARNING	1	2026-08-02 15:03:46.134	2026-08-02 15:03:46.137
48	2	79	2026-08-02 15:03:47.134	1	2026-08-02 15:33:47.134	2026-08-02 15:03:47.137	LEARNING	1	2026-08-02 15:03:47.134	2026-08-02 15:03:47.137
49	2	91	2026-08-02 15:03:48.444	1	2026-08-02 15:33:48.444	2026-08-02 15:03:48.447	LEARNING	1	2026-08-02 15:03:48.444	2026-08-02 15:03:48.447
50	2	110	2026-08-02 15:03:50.075	1	2026-08-02 15:33:50.075	2026-08-02 15:03:50.078	LEARNING	1	2026-08-02 15:03:50.075	2026-08-02 15:03:50.078
51	2	118	2026-08-02 15:03:56.971	1	2026-08-02 15:33:56.971	2026-08-02 15:03:56.974	LEARNING	1	2026-08-02 15:03:56.971	2026-08-02 15:03:56.974
32	2	4	2026-08-02 15:03:41.024	2	2026-08-02 23:04:36.739	2026-08-02 15:03:41.026	REVIEW	2	2026-08-02 20:04:36.739	2026-08-02 20:04:36.742
33	2	8	2026-08-02 15:03:41.393	2	2026-08-02 23:04:59.141	2026-08-02 15:03:41.395	REVIEW	2	2026-08-02 20:04:59.142	2026-08-02 20:04:59.144
58	2	138	2026-08-03 04:03:22.847	1	2026-08-03 04:33:22.847	2026-08-03 04:03:22.849	LEARNING	1	2026-08-03 04:03:22.847	2026-08-03 04:03:22.849
59	2	141	2026-08-03 04:03:45.386	1	2026-08-03 04:33:45.386	2026-08-03 04:03:45.388	LEARNING	1	2026-08-03 04:03:45.386	2026-08-03 04:03:45.388
35	2	22	2026-08-02 15:03:42.039	2	2026-08-03 06:53:39.544	2026-08-02 15:03:42.042	REVIEW	2	2026-08-03 03:53:39.544	2026-08-03 03:53:39.546
53	2	122	2026-08-03 03:54:14.485	1	2026-08-03 04:24:14.485	2026-08-03 03:54:14.488	LEARNING	1	2026-08-03 03:54:14.485	2026-08-03 03:54:14.488
54	2	127	2026-08-03 03:54:17.13	1	2026-08-03 04:24:17.13	2026-08-03 03:54:17.133	LEARNING	1	2026-08-03 03:54:17.13	2026-08-03 03:54:17.133
55	2	128	2026-08-03 04:00:40.555	1	2026-08-03 04:30:40.555	2026-08-03 04:00:40.557	LEARNING	1	2026-08-03 04:00:40.555	2026-08-03 04:00:40.557
56	2	135	2026-08-03 04:00:43.684	1	2026-08-03 04:30:43.684	2026-08-03 04:00:43.685	LEARNING	1	2026-08-03 04:00:43.684	2026-08-03 04:00:43.685
60	2	148	2026-08-03 05:21:13.286	1	2026-08-03 05:51:13.286	2026-08-03 05:21:13.288	LEARNING	1	2026-08-03 05:21:13.286	2026-08-03 05:21:13.288
61	2	143	2026-08-03 05:37:34.553	1	2026-08-03 06:07:34.553	2026-08-03 05:37:34.555	LEARNING	1	2026-08-03 05:37:34.553	2026-08-03 05:37:34.555
36	2	23	2026-08-02 15:03:42.251	2	2026-08-03 08:38:32.571	2026-08-02 15:03:42.253	REVIEW	2	2026-08-03 05:38:32.571	2026-08-03 05:38:32.573
37	2	25	2026-08-02 15:03:42.432	2	2026-08-03 08:46:39.216	2026-08-02 15:03:42.435	REVIEW	2	2026-08-03 05:46:39.216	2026-08-03 05:46:39.218
38	2	28	2026-08-02 15:03:42.608	3	2026-08-03 15:46:45.976	2026-08-02 15:03:42.61	REVIEW	3	2026-08-03 05:46:45.976	2026-08-03 05:46:45.977
39	2	34	2026-08-02 15:03:44.126	2	2026-08-03 08:50:44.4	2026-08-02 15:03:44.129	REVIEW	2	2026-08-03 05:50:44.401	2026-08-03 05:50:44.402
40	2	37	2026-08-02 15:03:44.319	2	2026-08-03 08:56:02.707	2026-08-02 15:03:44.321	REVIEW	2	2026-08-03 05:56:02.708	2026-08-03 05:56:02.712
41	2	41	2026-08-02 15:03:44.543	2	2026-08-03 09:14:37.683	2026-08-02 15:03:44.545	REVIEW	2	2026-08-03 06:14:37.684	2026-08-03 06:14:37.687
42	2	42	2026-08-02 15:03:45.143	2	2026-08-03 09:14:42.901	2026-08-02 15:03:45.146	REVIEW	2	2026-08-03 06:14:42.901	2026-08-03 06:14:42.904
44	2	48	2026-08-02 15:03:45.519	2	2026-08-03 09:14:53.748	2026-08-02 15:03:45.522	REVIEW	2	2026-08-03 06:14:53.748	2026-08-03 06:14:53.751
43	2	45	2026-08-02 15:03:45.326	2	2026-08-03 09:14:54.558	2026-08-02 15:03:45.329	REVIEW	2	2026-08-03 06:14:54.558	2026-08-03 06:14:54.562
45	2	51	2026-08-02 15:03:45.718	2	2026-08-03 09:14:55.832	2026-08-02 15:03:45.72	REVIEW	2	2026-08-03 06:14:55.832	2026-08-03 06:14:55.835
46	2	60	2026-08-02 15:03:45.899	2	2026-08-03 09:14:56.816	2026-08-02 15:03:45.901	REVIEW	2	2026-08-03 06:14:56.816	2026-08-03 06:14:56.819
34	2	16	2026-08-02 15:03:41.832	5	2026-08-11 08:18:01.161	2026-08-02 15:03:41.835	REVIEW	5	2026-08-08 08:18:01.161	2026-08-08 08:18:01.163
52	2	15	2026-08-02 16:13:54.332	3	2026-08-08 18:19:07.686	2026-08-02 16:13:54.334	REVIEW	3	2026-08-08 08:19:07.687	2026-08-08 08:19:07.689
\.
...
275	goal	Noun	Mục đích, mục tiêu	/goul/	purpose	Employees are expected to analyze and evaluate their annual goals.	Các nhân viên được yêu cầu phân tích và đánh giá các mục tiêu hàng năm của họ.	https://audio.tflat.vn/data/cache/images/300x225/g/o/goal2.png	https://audio.tflat.vn/audio/g/o/goal.mp3	Board Meeting & Committees	https://tienganhtflat.com/blog/toeic-words-board-meeting-committees	2026-07-24 17:22:34.132489	1
350	excursion	Noun	Cuộc đi tham quan, cuộc đi chơi tập thể	/iks'kə:ʃn/	a short trip made for pleasur	There are regular weekend excursions throughout the summer.	Có chuyến du ngoạn cuối tuần thường xuyên trong suốt mùa hè.	https://audio.tflat.vn/data/cache/images/300x225/e/x/excursion1.png	https://audio.tflat.vn/audio/e/x/excursion.mp3	Airlines	https://tienganhtflat.com/blog/toeic-words-airlines	2026-07-24 17:22:34.132489	1
933	nominee	Noun	người được đề cử	/ˌnɑːməˈniː/	a person selected	The nominee accepted the award.	Người được đề cử đã nhận giải.	\N	\N	Human Resources	\N	2026-07-24 18:01:26.486905	2
864	dedicate	Verb	cống hiến	/ˈdedɪkeɪt/	to devote	He dedicated his career to education.	Anh ấy cống hiến sự nghiệp cho giáo dục.	\N	\N	Human Resources	\N	2026-07-24 17:59:36.547339	1
57	provider	Noun	Nhà cung cấp 	/prəˈvaɪdə(r)/	a person or an organization that supplies somebody with something they need	The department was extremely pleased with the service they received from the phone provider.	Bộ phận hết sức hài lòng với dịch vụ mà họ nhận được từ nhà cung cấp dịch vụ điện thoại.	https://audio.tflat.vn/data/cache/images/300x225/p/r/provider1.png	https://audio.tflat.vn/audio/p/r/provider.mp3	Office Technology	https://tienganhtflat.com/blog/toeic-words-office-technology	2026-07-24 17:22:34.132489	1
...
188	description	Noun	‹sự› diễn tả, mô tả; diện mạo, hình dạng	/dis'kripʃn/	a piece of writing or speech that says what someone or something is like; the act of writing or saying in words what someone or something is like	This is the description of our new house.	Đây là mô tả của ngôi nhà mới của chúng tôi.	https://audio.tflat.vn/data/cache/images/300x225/d/e/description2.jpg	https://audio.tflat.vn/audio/d/e/description.mp3	Movies	https://tienganhtflat.com/blog/toeic-words-movies	2026-07-24 17:22:34.132489	1
600	risk	Noun	Nguy cơ, sự nguy hiểm, sự rủi ro	/rɪsk/	the possibility of something bad happening at some time in the future	The primary risk for most start-up businesses is insufficient capital.	Nguy cơ lớn nhất đối với hầu hết các cuộc khởi nghiệp là thiếu vốn.	https://audio.tflat.vn/data/cache/images/300x225/r/i/risk1.png	https://audio.tflat.vn/audio/r/i/risk.mp3	Business Planning	https://tienganhtflat.com/blog/toeic-words-business-planning	2026-07-24 17:22:34.132489	1
584	factor	Noun	Nhân tố, yếu tố	/'fæktə/	one of several things that cause or influence something	The result will depend on a number of different factors.	Kết quả sẽ phụ thuộc vào một số lượng những nhân tố khác nhau.	https://audio.tflat.vn/data/cache/images/300x225/f/a/factor1.png	https://audio.tflat.vn/audio/f/a/factor.mp3	Pharmacy	https://tienganhtflat.com/blog/toeic-words-pharmacy	2026-07-24 17:22:34.132489	1
234	characteristic	Noun	Đặc trưng, đặc điểm, đặc thù, cá biệt	/,kæriktə'ristik/	very typical of something or of somebody's character.	One characteristic of the store is that it is slow in mailing refund checks.	Một đặc điểm của cửa hàng là nó chậm chạp trong việc gửi hóa đơn hoàn trả.	https://audio.tflat.vn/data/images_example/300x225/o/n/one_charac_ex1_580de3767f8b9a3e688b456d.jpg	https://audio.tflat.vn/audio/c/h/characteristic.mp3	Warranties	https://tienganhtflat.com/blog/toeic-words-warranties	2026-07-24 17:22:34.132489	1
...
517	transaction	Noun	Sự giao dịch, công việc kinh doanh	/træn'zækʃn/	a piece of business that is done between people, especially an act of buying or selling	Banking transaction will appear on your monthly statement.	Giao dịch ngân hàng sẽ xuất hiện trong thông báo tài khoản ngân hàng mỗi tháng.	https://audio.tflat.vn/data/cache/images/300x225/t/r/transaction1.jpg	https://audio.tflat.vn/audio/t/r/transaction.mp3	Banking	https://tienganhtflat.com/blog/toeic-words-banking	2026-07-24 17:22:34.132489	1
562	majority	Noun	Phần lớn, đa số	/mə'dʤɔriti/	the largest part of a group of people or things	The majority of the group wanted to try the new Chinese restaurant.	Phần lớn nhóm muốn đi ăn thử ở nhà hàng Trung Quốc mới.	https://audio.tflat.vn/data/cache/images/300x225/m/a/majority1.png	https://audio.tflat.vn/audio/m/a/majority.mp3	Selecting A Restaurant	https://tienganhtflat.com/blog/toeic-words-selecting-a-restaurant	2026-07-24 17:22:34.132489	1
905	incentivize	Verb	khuyến khích	/ɪnˈsentɪvaɪz/	to motivate with rewards	The company incentivized employees.	Công ty đã khuyến khích nhân viên bằng phần thưởng.	\N	\N	Human Resources	\N	2026-07-24 18:01:26.486905	5
266	overview	Noun	Nhìn tồng quát, miêu tả chung, ngắn gọn	/´ouvə¸vju:/	a general description something	I did a quick overview of your teeth and they look in good shape.	Tôi đã khám tổng quát nhanh hàm răng của cô và chúng trông có vẻ tốt.	https://audio.tflat.vn/data/images_example/300x225/i/_/i_did_a_qu_ex1_56248d167f8b9a040dc66278.jpg	https://audio.tflat.vn/audio/o/v/overview.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	1
...
402	proximity	Noun	Sắp xỉ, sự gần gũi	/prɔk´simiti/	the state of being near someone or something in distance or time	The fans were worried by the proximity of the storm clouds.	Những người hâm mộ lo lắng bởi đám mây báo bão đến gần.	https://audio.tflat.vn/data/cache/images/300x225/p/r/proximity1.jpg	https://audio.tflat.vn/audio/p/r/proximity.mp3	Events	https://tienganhtflat.com/blog/toeic-words-events	2026-07-24 17:22:34.132489	1
409	candidate	Noun	Ứng cử viên, thí sinh, người dự tuyển	/'kændidit/	a person who is trying to be elected or is applying for a job	All of the candidates were ready for the competition.	Tất cả các ứng cử viên đã sẵn sàng cho cuộc thi.	https://audio.tflat.vn/data/cache/images/300x225/c/a/candidate1.jpg	https://audio.tflat.vn/audio/c/a/candidate.mp3	Job Ads & Recruitment	https://tienganhtflat.com/blog/toeic-words-job-ads-recruitment	2026-07-24 17:22:34.132489	1
224	association	Noun	Hội, hiệp hội	/ə,sousi'eiʃn/	an officcial group of people who have joined together for a particular purpose	I know that ASEAN stands for the Association of Southeast Asian Nations.	Tôi biết rằng ASEAN là viết tắt của Hiệp Hội Các Nước Đông Nam Á.	https://audio.tflat.vn/data/images_example/300x225/i/_/i_know_tha_ex1_580de37b7f8b9a3e688b4579.jpg	https://audio.tflat.vn/audio/a/s/association.mp3	Conference	https://tienganhtflat.com/blog/toeic-words-conference	2026-07-24 17:22:34.132489	1
487	revolution	Noun	Cuộc cách mạng	/,revə'lu:ʃn/	a great change in conditions, ways of working, beliefs, etc. ..that affects large numbers of people	We see a revolution in the computer field almost every day.	Chúng ta thấy một cuộc cách mạng trong lãnh vực máy tính hầu như mỗi ngày.	https://audio.tflat.vn/data/cache/images/300x225/r/e/revolution1.png	https://audio.tflat.vn/audio/r/e/revolution.mp3	Electronics	https://tienganhtflat.com/blog/toeic-words-electronics-3	2026-07-24 17:22:34.132489	1
420	beverage	Noun	Đồ uống	/'bəvəridʤ/	any type of drink except water	The flight attendant offered all passengers a cold beverage during the flight.	Tiếp viên hành không đã mời mọi hành khách một thức uống lạnh trong suốt chuyển bay.	https://audio.tflat.vn/data/cache/images/300x225/b/e/beverage1.png	https://audio.tflat.vn/audio/b/e/beverage.mp3	General Travel	https://tienganhtflat.com/blog/toeic-words-general-travel	2026-07-24 17:22:34.132489	1
369	action	Noun	Hành động, hoạt động	/ˈækʃn/	the events in a story, play, etc	I like action films.	Tôi thích phim hành động.	https://audio.tflat.vn/data/cache/images/300x225/a/c/action1.png	https://audio.tflat.vn/audio/a/c/action.mp3	Theater	https://tienganhtflat.com/blog/toeic-words-theater	2026-07-24 17:22:34.132489	1
...
414	qualification	Noun	Năng lực, trình độ (để làm cái gì)	/,kwɔlifi'keiʃn/	a skill or type of experience that you need for a particular job or activity	It is easy for him to find a good job with such good qualifications.	Rất dễ dàng cho anh ta để tìm một công việc tốt với trình độ tốt như vậy.	https://audio.tflat.vn/data/cache/images/300x225/q/u/qualification.jpg	https://audio.tflat.vn/audio/q/u/qualification.mp3	Job Ads & Recruitment	https://tienganhtflat.com/blog/toeic-words-job-ads-recruitment	2026-07-24 17:22:34.132489	1
405	stage	Noun	Trình diễn, dàn cảnh; sắp xếp, tổ chức	/steɪdʒ/	a period or state that something or someone passes through	A historic house can be the perfect site to stage a small reception.	Một ngôi nhà lịch sử có thể là một nơi lý tưởng để tổ chức một cuộc chiêu đãi nhỏ.	https://audio.tflat.vn/data/cache/images/300x225/s/t/stage1.jpg	https://audio.tflat.vn/audio/s/t/stage.mp3	Events	https://tienganhtflat.com/blog/toeic-words-events	2026-07-24 17:22:34.132489	1
...
48	salary	Noun	Lương hàng tháng	/ˈsæləri/	money that employees receive for doing their job	The technician was pleased to have a raise in salary after only six months on the job.	Người kỹ thuật viên đã hài lòng khi có sự tăng lương chỉ sau 6 tháng làm việc.	https://audio.tflat.vn/data/cache/images/300x225/s/a/salary1.png	https://audio.tflat.vn/audio/s/a/salary.mp3	Health	https://tienganhtflat.com/blog/toeic-words-health	2026-07-24 17:22:34.132489	2
389	recommendation	Noun	Lời dặn dò, đề nghị 	/,rekəmen'deiʃn/	an official suggestion about the best thing to do	It is important to follow the doctor's recommendations if you want to improve your health.	Thật quan trọng để làm theo những dặn dò của bác sĩ nếu bạn muốn cải thiện sức khỏe.	https://audio.tflat.vn/data/cache/images/300x225/r/e/recommendation.png	https://audio.tflat.vn/audio/r/e/recommendation.mp3	Doctor's Office	https://tienganhtflat.com/blog/toeic-words-doctor-s-office	2026-07-24 17:22:34.132489	2
203	method	Noun	Phương pháp, cách thức	/ˈmeθəd/	a particular way of doing something	Gloria perfected a simple method for making croissants.	Gloria đã hoàn thành một phương pháp đơn giản để làm bánh sừng bò.	https://audio.tflat.vn/data/cache/images/300x225/m/e/method1.jpg	https://audio.tflat.vn/audio/m/e/method.mp3	Cooking As A Career	https://tienganhtflat.com/blog/toeic-words-cooking-as-a-career	2026-07-24 17:22:34.132489	2
150	background	Noun	Kiến thức, kinh nghiệm	/'bækgraund/	the details of a person's familly, education, experience	Your background in the publishing industry is a definite asset for this job.	Kiến thức của anh trong công nghiệp xuất bản là một vốn quý rõ ràng cho công việc này.	https://audio.tflat.vn/data/cache/images/300x225/b/a/background1.jpg	https://audio.tflat.vn/audio/b/a/background.mp3	Apply and Interviewing	https://tienganhtflat.com/blog/toeic-words-apply-and-interviewing	2026-07-24 17:22:34.132489	2
430	shopping	Noun	Mua sắm	/ˈʃɒpɪŋ/	\N	Let's go shopping.	Nào cùng nhau đi mua sắm.	https://audio.tflat.vn/data/cache/images/300x225/s/h/shopping11.jpg	https://audio.tflat.vn/audio/s/h/shopping1.mp3	Shopping	https://tienganhtflat.com/blog/toeic-words-shopping	2026-07-24 17:22:34.132489	2
...
553	translation	Noun	Bản dịch, bài dịch	/træns'leiʃn/	the process of changing something that is written or spoken into another language.	The translation of the statement from Japanese into English was very helpful.	Bản dịch báo cáo từ tiếng Nhật sang tiếng Anh là rất có ích.	https://audio.tflat.vn/data/cache/images/300x225/t/r/translation2.png	https://audio.tflat.vn/audio/t/r/translation.mp3	Financial Statements	https://tienganhtflat.com/blog/toeic-words-financial-statements	2026-07-24 17:22:34.132489	3
541	provision	Noun	Dự phòng, điều khoản	/prəˈvɪʒn/	a condition or an arrangement in a legal document	The father made provision for his children through his will.	Người cha đã truyền lại di chúc cho những đứa con của mình.	https://audio.tflat.vn/data/cache/images/300x225/p/r/provision1.png	https://audio.tflat.vn/audio/p/r/provision.mp3	Contracts	https://tienganhtflat.com/blog/toeic-words-contracts	2026-07-24 17:22:34.132489	3
107	preparation	Noun	‹sự› chuẩn bị, sửa soạn	/,prepə'reiʃn/	the act or process of getting ready for something or making something ready	They are making preparations for war.	Họ đang chuẩn bị cho chiến tranh.	https://audio.tflat.vn/data/cache/images/300x225/p/r/preparation.jpg	https://audio.tflat.vn/audio/p/r/preparation.mp3	Taxes	https://tienganhtflat.com/blog/toeic-words-taxes	2026-07-24 17:22:34.132489	3
198	apprentice	Noun	Người học việc, người mới vào nghề	/ə'prentis/	young person who works for an employer for a fixed period of time in order to learn the particular skills needed in their job	The cooking school has an apprentice program that places students in restaurants to gain work experience.	Trường dạy nấu ăn có một chương trình học nghề là đưa học viên đến các nhà hàng để lấy kinh nghiệm làm việc.	https://audio.tflat.vn/data/cache/images/300x225/a/p/apprentice1.png	https://audio.tflat.vn/audio/a/p/apprentice.mp3	Cooking As A Career	https://tienganhtflat.com/blog/toeic-words-cooking-as-a-career	2026-07-24 17:22:34.132489	3
261	encouragement	Noun	Khuyến khích, cổ vũ, niềm động viên	/in'kʌridʤmənt/	the act of encouraging someone to do something	Let me offer you some encouragement about your crooked teeth.	Để tôi sẵn sàng cho anh vài sự động viên về hàm răng lệch lạc của anh.	https://audio.tflat.vn/data/cache/images/300x225/e/n/encouragement2.jpg	https://audio.tflat.vn/audio/e/n/encouragement.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	3
382	appointment	Noun	Cuộc hẹn, sự hẹn gặp	/ə'pɔintmənt/	a formal arrangement to meet or visit someone at a particular time	I've got a dentist appointment at 3 o'clock.	Tôi đã có một cuộc hẹn với nha sĩ lúc 03:00.	https://audio.tflat.vn/data/cache/images/300x225/a/p/appointment2.jpg	https://audio.tflat.vn/audio/a/p/appointment.mp3	Doctor's Office	https://tienganhtflat.com/blog/toeic-words-doctor-s-office	2026-07-24 17:22:34.132489	3
...
540	party	Noun	Đảng, phái, nhóm	/'pɑ:ti/	one of the people or groups of people involved in a legal agreemen	The parties agreed to settlement in their contract dispute.	Các bên đã nhất trí đi đến một thỏa thuận trong hợp đồng gây tranh cãi của họ.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_partie_ex1_56248cf37f8b9af80c011dc1.jpg	https://audio.tflat.vn/audio/p/a/party.mp3	Contracts	https://tienganhtflat.com/blog/toeic-words-contracts	2026-07-24 17:22:34.132489	3
535	cancellation	Noun	Sự bãi bỏ, hủy bỏ	/,kænse'leiʃn/	a decision to stop something that has already been arranged from happening	The cancellation of her flight caused her problems for the rest of the week.	Việc hủy chuyến bay đã gây cho cô ấy nhiều vấn đề trong những ngày còn lại của tuần.	https://audio.tflat.vn/data/cache/images/300x225/c/a/cancellation.jpg	https://audio.tflat.vn/audio/c/a/cancellation.mp3	Contracts	https://tienganhtflat.com/blog/toeic-words-contracts	2026-07-24 17:22:34.132489	3
289	impact	Noun	Sự tác động mạnh, ảnh hưởng mạnh	/ˈɪmpakt/	the powerful effect that something has on someone or something	The story of the presidential scandal had a huge impact on the public.	Bài báo về vụ bê bối của tổng thống đã có tác động to lớn đến công chúng.	https://audio.tflat.vn/data/cache/images/300x225/i/m/impact1.png	https://audio.tflat.vn/audio/i/m/impact.mp3	Media	https://tienganhtflat.com/blog/toeic-words-media	2026-07-24 17:22:34.132489	3
...
271	agenda	Noun	Đề tài thảo luận, chương trình nghị sự	/ə´dʒendə/	\N	Newspapers have been accused of trying to set the agenda for the government.	Báo chí đã bị buộc tội cố gắng thiết lập chương trình nghị sự của chính phủ.	https://audio.tflat.vn/data/cache/images/300x225/a/g/agenda1.png	https://audio.tflat.vn/audio/a/g/agenda.mp3	Board Meeting & Committees	https://tienganhtflat.com/blog/toeic-words-board-meeting-committees	2026-07-24 17:22:34.132489	4
53	capacity	Noun	Sức chứa, dung tích	/kə'pæsiti/	the number of things or people that a container or space can hold	The new conference room is much larger and has a capacity of one hundred people.	Phòng họp mới thì lớn hơn nhiều (phòng cũ) và có khả năng chứa được một trăm người.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_new_co_ex1_56248d0b7f8b9a000de3cf4d.jpg	https://audio.tflat.vn/audio/c/a/capacity.mp3	Office Technology	https://tienganhtflat.com/blog/toeic-words-office-technology	2026-07-24 17:22:34.132489	4
446	discount	Noun	Sự giảm giá	/ˈdɪskaʊnt/	an amount of money that is taken off the usual cost of something	Do you get a discount if you pay in cash?	Bạn có được sự giảm giá nếu trả bằng tiền mặt không?	https://audio.tflat.vn/data/cache/images/300x225/d/i/discount-n1.jpg	https://audio.tflat.vn/audio/d/i/discount-n.mp3	Invoice	https://tienganhtflat.com/blog/toeic-words-invoice	2026-07-24 17:22:34.132489	4
184	movie	Noun	Phim, điện ảnh	/'mu:vi/	\N	I like watching movies very much.	Tôi thích xem phim rất nhiều.	https://audio.tflat.vn/data/cache/images/300x225/m/o/movie2.jpg	https://audio.tflat.vn/audio/m/o/movie.mp3	Movies	https://tienganhtflat.com/blog/toeic-words-movies	2026-07-24 17:22:34.132489	4
...
251	experiment	Noun	Cuộc thí nghiệm	/ɪkˈsperɪmənt/	a scientific test that is done in order to study what happens and to gain new knowledge	Some people believe that experiments on animals should be banned.	Một số người cho rằng những thí nghiệm trên động vật nên bị cấm.	https://audio.tflat.vn/data/cache/images/300x225/e/x/experiment2.png	https://audio.tflat.vn/audio/e/x/experiment.mp3	Product Development	https://tienganhtflat.com/blog/toeic-words-product-development	2026-07-24 17:22:34.132489	4
451	order	Noun	Đơn đặt hàng	/'ɔ:də/	a request to make or supply goods	The customer placed an order for ten new chairs.	Người khách hàng đưa đơn đặt hàng 10 cái ghế mới.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_custom_ex1_56248cf37f8b9af80c011edd.jpg	https://audio.tflat.vn/audio/o/r/order.mp3	Invoice	https://tienganhtflat.com/blog/toeic-words-invoice	2026-07-24 17:22:34.132489	5
520	attitude	Noun	Thái độ	/'ætitju:d/	the way that you think and feel about somebody/something.	Each person has his or her own attitude towards life.	Mỗi người có thái độ sống riêng.	https://audio.tflat.vn/data/cache/images/300x225/a/t/attitude1.jpg	https://audio.tflat.vn/audio/a/t/attitude.mp3	Investment	https://tienganhtflat.com/blog/toeic-words-investment	2026-07-24 17:22:34.132489	4
468	train	Noun	Tàu hỏa	/treɪn/	\N	We love travelling by train.	Chúng tôi thích đi du lịch bằng tàu hỏa.	https://audio.tflat.vn/data/cache/images/300x225/t/r/train2.jpg	https://audio.tflat.vn/audio/t/r/train.mp3	Trains	https://tienganhtflat.com/blog/toeic-words-trains	2026-07-24 17:22:34.132489	4
...
574	reflection	Noun	‹sự› phản chiếu, phản xạ, hình ảnh	/rɪˈflekʃn/	a sign that shows the state or nature of something	She saw her reflection in the mirror.	Cô ấy nhìn ảnh của mình ở trong gương.	https://audio.tflat.vn/data/cache/images/300x225/r/e/reflection2.jpg	https://audio.tflat.vn/audio/r/e/reflection.mp3	Inventory	https://tienganhtflat.com/blog/toeic-words-inventory	2026-07-24 17:22:34.132489	5
...
263	habit	Noun	Thói quen	/ˈhæbɪt/	a thing that you do often and almost without thinking	Negative thinking can become a habit.	Suy nghĩ tiêu cực có thể trở thành một thói quen.	https://audio.tflat.vn/data/cache/images/300x225/h/a/habit1.png	https://audio.tflat.vn/audio/h/a/habit.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	5
...
396	dimension	Noun	Kích thước, khổ	/di'menʃn/	a measurement in space, for example the height, width, or length of something	What are the dimensions of the ballroom?	Kích thước của phòng nhảy ra sao?	https://audio.tflat.vn/data/cache/images/300x225/d/i/dimension1.png	https://audio.tflat.vn/audio/d/i/dimension.mp3	Events	https://tienganhtflat.com/blog/toeic-words-events	2026-07-24 17:22:34.132489	5
412	match	Noun	Người ngang tài ngang sức	/mætʃ/	a fit, a similarity	It is difficult to make a decision when both candidates seem to be a perfect match.	Thật là khó đưa ra quyết định khi mà cả 2 ứng viên dường như ngang sức ngang tài.	https://audio.tflat.vn/data/cache/images/300x225/m/a/match-n1.jpg	https://audio.tflat.vn/audio/m/a/match-n.mp3	Job Ads & Recruitment	https://tienganhtflat.com/blog/toeic-words-job-ads-recruitment	2026-07-24 17:22:34.132489	5
...
358	carrier	Noun	‹người/công ty› vận chuyển, vận tải	/'kæriə/	a company that carries goods or passengers from one place to another, especially by air	Lou, our favorite carrier, takes extra care of our boxes marked 'fragile'.	Lou, người vận chuyển ưa thich của chúng tôi, đã phải cẩn thận hơn thường lệ với những cái hộp của chúng tôi có dán nhãn Dễ vỡ.	https://audio.tflat.vn/data/images_example/300x225/l/o/lou_our_fa_ex1_56248d157f8b9a040dc65f34.jpg	https://audio.tflat.vn/audio/c/a/carrier.mp3	Shipping	https://tienganhtflat.com/blog/toeic-words-shipping	2026-07-24 17:22:34.132489	5
...
506	accept	Verb	Nhận, chấp nhận	/ək'sept/	to say “yes” to an offer, invitation, etc.	She accepts the gift with a big smile, and thanks her boyfriend several times.	Cô ấy chấp nhận món quà với nụ cười lớn và cảm ơn bạn trai nhiều lần. 	https://audio.tflat.vn/data/cache/images/300x225/a/c/accept1.png	https://audio.tflat.vn/audio/a/c/accept.mp3	Banking	https://tienganhtflat.com/blog/toeic-words-banking	2026-07-24 17:22:34.132489	1
...
7	negotiate	Verb	Thương lượng, đàm phán, điều đình	/ni'gouʃieit/	to try to reach an agreement by formal discussion	You must know what you want and what you can accept when you negotiate a salary.	Anh phải biết mình muốn gì và mình có thể chấp nhận gì khi thương lượng về lương bổng.	https://audio.tflat.vn/data/cache/images/300x225/n/e/negotiate1.png	https://audio.tflat.vn/audio/n/e/negotiate.mp3	Salaries & Benefits	https://tienganhtflat.com/blog/toeic-words-salaries-benefits	2026-07-24 17:22:34.132489	1
149	apply	Verb	Nộp, ứng tuyển	/ə'plai/	to make a formal request, usually in writing, for something such as a job, a place at college, university	The college graduate applied for three jobs and received three offers.	Người tốt nghiệp cao đẳng đã xin việc ở 3 nơi và nhận được 3 lời mời chào.	https://audio.tflat.vn/data/cache/images/300x225/a/p/apply1.jpg	https://audio.tflat.vn/audio/a/p/apply.mp3	Apply and Interviewing	https://tienganhtflat.com/blog/toeic-words-apply-and-interviewing	2026-07-24 17:22:34.132489	1
259	catch up	Verb	Làm kịp, kịp thời gian	/katʃ ʌp/	to bring up to date	The dental assistant was able to catch up on her paperwork in between patients.	Người trợ tá nha sĩ đã kịp làm công việc giấy tờ của mình giữa các lần khám bệnh nhân.	https://audio.tflat.vn/data/cache/images/300x225/c/a/catch_up1.jpg	https://audio.tflat.vn/audio/c/a/catch_up.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	1
...
483	network	Verb	Kết nối, liên kết	/'netwə:k/	a number of computers and other devices that are connected together	More and more PCs are networked together.	Ngày càng nhiều máy tính được kết nối với nhau.	https://audio.tflat.vn/data/cache/images/300x225/n/e/network1.jpg	https://audio.tflat.vn/audio/n/e/network.mp3	Electronics	https://tienganhtflat.com/blog/toeic-words-electronics-3	2026-07-24 17:22:34.132489	1
387	manage	Verb	Quán lý, điều hành	/'mænidʤ/	to succeed in doing something, especially something difficult	I managed to pass the exams.	Tôi đã xoay sở vượt qua được các kỳ thi.	https://audio.tflat.vn/data/cache/images/300x225/m/a/manage1.png	https://audio.tflat.vn/audio/m/a/manage.mp3	Doctor's Office	https://tienganhtflat.com/blog/toeic-words-doctor-s-office	2026-07-24 17:22:34.132489	1
...
264	illuminate	Verb	Chiếu sáng, làm sáng tỏ	/i'ju:mineit/	to shine light on something	Let me turn on more lights to properly illuminate the back teeth.	Để tôi bật thêm đèn để chiếu sáng đúng mức hàm răng đen.	https://audio.tflat.vn/data/cache/images/300x225/i/l/illuminate1.png	https://audio.tflat.vn/audio/i/l/illuminate.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	1
219	shut down	Verb	Tắt máy, ngừng hoạt động	/ʃʌt/	it stops being often for bussiness	Please shut down the computer before you leave.	Vui lòng tắt máy trước khi bạn ngừng làm việc.	https://audio.tflat.vn/data/cache/images/300x225/s/h/shut_down2.jpg	https://audio.tflat.vn/audio/s/h/shut_down.mp3	Computers and the Internet	https://tienganhtflat.com/blog/toeic-words-computers-and-the-internet	2026-07-24 17:22:34.132489	1
...
366	ship	Verb	Vận chuyển	/ʃip/	to send	Eva shipped the package carefully, since she knew the contents were made of glass.	Eva đã chuyển hàng một cách cẩn thận, bởi vì cô biết bên trong được làm bằng thủy tinh.	https://audio.tflat.vn/data/images_example/300x225/e/v/eva_shippe_ex1_56248d157f8b9a040dc65f44.jpg	https://audio.tflat.vn/audio/s/h/ship.mp3	Shipping	https://tienganhtflat.com/blog/toeic-words-shipping	2026-07-24 17:22:34.132489	1
587	monitor	Verb	Quan sát, theo dõi	/'mɔnitə/	to watch and check something over a period of time	The patient had weekly appointments so that the doctor could monitor their progress.	Người bệnh có các cuộc hẹn hàng tuần để cho bác sĩ có thể theo dõi tiến triển của họ.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_patien_ex1_56248d177f8b9a040dc662d0.jpg	https://audio.tflat.vn/audio/m/o/monitor.mp3	Pharmacy	https://tienganhtflat.com/blog/toeic-words-pharmacy	2026-07-24 17:22:34.132489	1
463	prefer	Verb	Thích hơn	/prɪˈfɜ:r/	to like one thing or person better than another	I prefer reading a book to watching TV.	Tôi thích đọc sách hơn xem TV.	https://audio.tflat.vn/data/cache/images/300x225/p/r/prefer1.png	https://audio.tflat.vn/audio/p/r/prefer.mp3	Music	https://tienganhtflat.com/blog/toeic-words-music	2026-07-24 17:22:34.132489	1
...
42	emphasize	Verb	Nhấn mạnh, làm nổi bật	/ˈɛmfəˌsaɪz/	to give special importance to something	The nurse emphasized the importance of eating a balanced diet.	Người y tá nhấn mạnh tầm quan trọng của việc ăn uống theo chế độ cân bằng.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_nurse__ex1_56248d167f8b9a040dc66284.png	https://audio.tflat.vn/audio/e/m/emphasize.mp3	Health	https://tienganhtflat.com/blog/toeic-words-health	2026-07-24 17:22:34.132489	2
248	assume	Verb	Đảm đương, gánh vác	/ə'sju:m/	to take or begin to have power or responsibility	It is generally assumed that stress is caused by too much work.	Nhiều người tin rằng sự căng thẳng gây ra bởi quá nhiều công việc.	https://audio.tflat.vn/data/cache/images/300x225/a/s/assume1.png	https://audio.tflat.vn/audio/a/s/assume.mp3	Product Development	https://tienganhtflat.com/blog/toeic-words-product-development	2026-07-24 17:22:34.132489	2
...
210	allocate	Verb	Cấp cho, phân phối	/ˈæləkeɪt/	to give something officially to somebody / something for a particular purpose	The office manager did not allocate enough money to purchase software.	Người quản lý văn phòng không cấp đủ tiền để mua sắm phần mềm.	https://audio.tflat.vn/data/cache/images/300x225/a/l/allocate1.png	https://audio.tflat.vn/audio/a/l/allocate.mp3	Computers and the Internet	https://tienganhtflat.com/blog/toeic-words-computers-and-the-internet	2026-07-24 17:22:34.132489	2
...
572	disturb	Verb	Quấy rầy, làm phiền	/dis'tə:b/	to interrupt somebody when they are trying to work	Let's see how many products we can count in advance of inventory so we disturb fewer customers.	Hãy xem có bao nhiêu sản phẩm chúng ta có thể đếm trước khi kiểm kê để cho chúng ta làm phiền khách hàng ít hơn.	https://audio.tflat.vn/data/cache/images/300x225/d/i/disturb1.png	https://audio.tflat.vn/audio/d/i/disturb.mp3	Inventory	https://tienganhtflat.com/blog/toeic-words-inventory	2026-07-24 17:22:34.132489	2
482	facilitate	Verb	Làm cho dễ dàng, làm cho thuận tiện	/fə'siliteit/	to make an action possible or easier	The computer program facilitated the scheduling of appointments.	Chương trình máy tính làm cho việc lập lịch các buổi hẹn được thuận tiện.	https://audio.tflat.vn/data/cache/images/300x225/f/a/facilitate1.png	https://audio.tflat.vn/audio/f/a/facilitate.mp3	Electronics	https://tienganhtflat.com/blog/toeic-words-electronics-3	2026-07-24 17:22:34.132489	2
516	take out	Verb	Rút (tiền)	/A/	remove	When can I take money out of bank?	Khi nào tôi có thể rút tiền khỏi ngân hàng	https://audio.tflat.vn/data/cache/images/300x225/t/a/take_out1.jpg	https://audio.tflat.vn/audio/t/a/take_out.mp3	Banking	https://tienganhtflat.com/blog/toeic-words-banking	2026-07-24 17:22:34.132489	2
...
186	combine	Verb	Kết hợp, phối hợp	/'kɔmbain/	to come together to form a single thing or group	The director combined two previously separate visual techniques.	Đạo diễn đã kết hợp 2 kỹ xảo hình ảnh riêng biệt trước đây lại với nhau.	https://audio.tflat.vn/data/cache/images/300x225/c/o/combine1.png	https://audio.tflat.vn/audio/c/o/combine.mp3	Movies	https://tienganhtflat.com/blog/toeic-words-movies	2026-07-24 17:22:34.132489	2
...
352	extend	Verb	Gia hạn, kéo dài (thời hạn...)	/iks'tend/	to make something longer or larger	There are plans to extend the subway line in this city.	Có kế hoạch để mở rộng đường tàu điện ngầm trong thành phố này.	https://audio.tflat.vn/data/cache/images/300x225/e/x/extend1.png	https://audio.tflat.vn/audio/e/x/extend.mp3	Airlines	https://tienganhtflat.com/blog/toeic-words-airlines	2026-07-24 17:22:34.132489	2
...
133	tempt	Verb	Xúi giục, cám dỗ	/tempt/	to attract someone or make someone want to do or have something	I am tempted by the idea of driving across the country instead of flying.	Tôi bị cám dỗ bởi ý tưởng lái xe xuyên qua đất nước thay vì đi máy bay.	https://audio.tflat.vn/data/cache/images/300x225/t/e/tempt1.png	https://audio.tflat.vn/audio/t/e/tempt.mp3	Car Rentals	https://tienganhtflat.com/blog/toeic-words-car-rentals	2026-07-24 17:22:34.132489	3
432	bear	Verb	Chịu đựng, cam chịu	/beə/	to be able to accept and deal with something unpleasant	Moya doesn't like crowds so she cannot bear shopping during the holiday rush.	Moya không thích đám đông vì thế cô không chịu đi mua sắm trong kỳ đổ xô đi sắm dịp lễ.	https://audio.tflat.vn/data/cache/images/300x225/b/e/bear1.jpg	https://audio.tflat.vn/audio/b/e/bear.mp3	Shopping	https://tienganhtflat.com/blog/toeic-words-shopping	2026-07-24 17:22:34.132489	3
140	forget	Verb	Quên	/fərˈɡet/	to be unable to remember something	The waiter forgets bringing the rolls, annoying the customer.	Anh nhân viên phục vụ quên mang các ổ bánh mì, gây bực mình cho người khách.	https://audio.tflat.vn/data/cache/images/300x225/f/o/forget1.png	https://audio.tflat.vn/audio/f/o/forget.mp3	Eating Out	https://tienganhtflat.com/blog/toeic-words-eating-out	2026-07-24 17:22:34.132489	3
170	opt	Verb	Chọn, chọn lựa; quyết định	/ɔpt/	to choose, to decide on	The operations manager opted for the less expensive office design.	Trưởng phòng tác nghiệp đã chọn bản thiết kế văn phòng ít tốn kém.	https://audio.tflat.vn/data/cache/images/300x225/o/p/opt1.png	https://audio.tflat.vn/audio/o/p/opt.mp3	Property & Departments	https://tienganhtflat.com/blog/toeic-words-property-departments	2026-07-24 17:22:34.132489	3
378	rehearse	Verb	Diễn tập	/rɪˈhɜːs/	to practice or make people practice a play, piece of music, etc. in preparation for a public performance	Today, we'll just rehearse the final scene.	Hôm nay, chúng tôi sẽ chỉ tập luyện cảnh cuối cùng.	https://audio.tflat.vn/data/cache/images/300x225/r/e/rehearse1.png	https://audio.tflat.vn/audio/r/e/rehearse.mp3	Theater	https://tienganhtflat.com/blog/toeic-words-theater	2026-07-24 17:22:34.132489	3
...
328	mention	Verb	Nói đến, đề cập đếm, đề xuất	/'menʃn/	an act of refering to somebody / something in speech or writing	You should mention in the letter that we can arrange for mailing the brochures as well as printing them.	Anh nên đề cập trong thư rằng chúng ta có thể thu xếp gửi (thư) tờ bướm cũng như là in ấn chúng.	https://audio.tflat.vn/data/cache/images/300x225/m/e/mention1.jpg	https://audio.tflat.vn/audio/m/e/mention.mp3	Correspondence	https://tienganhtflat.com/blog/toeic-words-correspondence	2026-07-24 17:22:34.132489	3
...
293	subscribe	Verb	Đặt mua một cái gì đó định kỳ, đăng ký	/səbˈskraɪb/	to pay an amount of money regularly in order to receive or use something	We subscribe to several sports channels (= on TV).	Chúng tôi đăng ký vào một số kênh thể thao (trên TV).	https://audio.tflat.vn/data/cache/images/300x225/s/u/subscribe1.jpg	https://audio.tflat.vn/audio/s/u/subscribe.mp3	Media	https://tienganhtflat.com/blog/toeic-words-media	2026-07-24 17:22:34.132489	3
538	establish	Verb	Thành lập, thiết lập	/is'tæbliʃ/	to start or create an organization, a system	This company was established in 2010.	Công ty này được thành lập vào năm 2010.	https://audio.tflat.vn/data/cache/images/300x225/e/s/establish1.png	https://audio.tflat.vn/audio/e/s/establish.mp3	Contracts	https://tienganhtflat.com/blog/toeic-words-contracts	2026-07-24 17:22:34.132489	3
...
537	engage	Verb	Thu hút (sự chú ý…), giành được (tình cảm…)	/in'geidʤ/	to become involved in, to participate	He really wants to engage his classmates, but he doesn't know how to do that.	Cậu ấy thực sự muốn giành được cảm tình của các bạn cùng lớp, nhưng cậu ấy không biết cách làm thế nào.	https://audio.tflat.vn/data/cache/images/300x225/e/n/engage.jpg	https://audio.tflat.vn/audio/e/n/engage.mp3	Contracts	https://tienganhtflat.com/blog/toeic-words-contracts	2026-07-24 17:22:34.132489	3
579	verify	Verb	Kiểm tra lại, thẩm tra, xác minh	/'verifai/	to check that something is true or accurate	We have no way of verifying his story.	Chúng tôi không có cách nào để xác minh câu chuyện của anh ấy.	https://audio.tflat.vn/data/cache/images/300x225/v/e/verify1.png	https://audio.tflat.vn/audio/v/e/verify.mp3	Inventory	https://tienganhtflat.com/blog/toeic-words-inventory	2026-07-24 17:22:34.132489	3
165	hamper	Verb	Cản trở, gây trở ngại	/'hæmpə/	to prevent someone from easily doing or achieving something	The lack of supplies hampered our ability to finish on schedule.	Việc thiếu đồ dự trữ đã gây trở ngại cho khả năng hoàn thành đúng thời gian của chúng tôi.	https://audio.tflat.vn/data/cache/images/300x225/h/a/hamper2.png	https://audio.tflat.vn/audio/h/a/hamper.mp3	Property & Departments	https://tienganhtflat.com/blog/toeic-words-property-departments	2026-07-24 17:22:34.132489	3
265	irritate	Verb	Kích thích, làm tấy lên, làm rát	/'iriteit/	to annoy someone, especially by something you continuously do	Aspirin irritates my stomach.	Aspirin kích ứng dạ dày của tôi.	https://audio.tflat.vn/data/images_example/300x225/a/s/aspirin_ir_ex1_56248d167f8b9a040dc66274.jpg	https://audio.tflat.vn/audio/i/r/irritate.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	3
...
113	admire	Verb	Ngưỡng mộ	/ədˈmaɪə(r)/	to respect someone for what they are or for what they have done	What she did makes me admire her greatly.	Những gì cô ấy làm khiến tôi rất ngưỡng mộ cô ấy.	https://audio.tflat.vn/data/cache/images/300x225/a/d/admire1.png	https://audio.tflat.vn/audio/a/d/admire.mp3	Museums	https://tienganhtflat.com/blog/toeic-words-museums	2026-07-24 17:22:34.132489	3
...
208	draw	Verb	Thu hút, lôi cuốn	/drɔ:/	to attract or interest someone	Matthew was drawn to a career in cooking.	Matthew đã bị lôi cuốn với công việc nấu ăn.	https://audio.tflat.vn/data/cache/images/300x225/d/r/draw-v2.jpg	https://audio.tflat.vn/audio/d/r/draw-v.mp3	Cooking As A Career	https://tienganhtflat.com/blog/toeic-words-cooking-as-a-career	2026-07-24 17:22:34.132489	3
3	compensate	Verb	Bù, đền bù, bồi thường	/'kɔmpenseit/	to provide something good to balance or reduce the bad effects of damage, loss	If you are injured in a traffic accident, you can be compensated for your losses.	Nếu bạn bị thương trong một tai nạn giao thông, bạn có thể được bồi thường mọi thiệt hại. 	https://audio.tflat.vn/data/cache/images/300x225/c/o/compensate1.png	https://audio.tflat.vn/audio/c/o/compensate.mp3	Salaries & Benefits	https://tienganhtflat.com/blog/toeic-words-salaries-benefits	2026-07-24 17:22:34.132489	3
...
443	charge	Verb	Tính phí	/tʃɑːdʒ/	to ask an amount of money for goods or a service	What did they charge for the repairs?	Họ đã tính phí gì cho việc sửa chữa?	https://audio.tflat.vn/data/cache/images/300x225/c/h/charge1.png	https://audio.tflat.vn/audio/c/h/charge.mp3	Invoice	https://tienganhtflat.com/blog/toeic-words-invoice	2026-07-24 17:22:34.132489	4
247	ascertain	Verb	Biết chắc, xác định rõ ràng	/,æsə'tein/	\N	A necessary part of product development is to ascertain whether the product is safe.	Một việc cần thiết cho sự phát triển sản phẩm là biết chắc sản phẩm có an toàn hay không.	https://audio.tflat.vn/data/cache/images/300x225/a/s/ascertain1.png	https://audio.tflat.vn/audio/a/s/ascertain.mp3	Product Development	https://tienganhtflat.com/blog/toeic-words-product-development	2026-07-24 17:22:34.132489	4
233	take part in	Verb	Tham dự, tham gia	/teɪk pɑːt ɪn/	to be involved in something	We could not get enough people to take part in the meeting, so we canceled it.	Chúng tôi không có đủ người tham dự cuộc họp, vì vậy chúng tôi hủy bỏ nó.	https://audio.tflat.vn/data/cache/images/300x225/t/a/take_part_in2.jpg	https://audio.tflat.vn/audio/t/a/take_part_in.mp3	Conference	https://tienganhtflat.com/blog/toeic-words-conference	2026-07-24 17:22:34.132489	4
453	rectify	Verb	Sửa cho đúng, sửa cho ngay	/'rektifai/	to put right something that is wrong	Embarrassed at his behavior, he rectified the situation by writing a letter of apology.	Xấu hổ về thái độ của mình, anh ta đã sửa chữa tình huống bằng cách viết thư tạ lỗi.	https://audio.tflat.vn/data/cache/images/300x225/r/e/rectify1.png	https://audio.tflat.vn/audio/r/e/rectify.mp3	Invoice	https://tienganhtflat.com/blog/toeic-words-invoice	2026-07-24 17:22:34.132489	4
...
63	generate	Verb	Làm ra, tạo ra, phát ra	/'dʤenəreit/	to produce or create something	The new training program generated a lot of interest among employees.	Chương trình huấn luyện mới đã tạo ra nhiều lợi ích cho mỗi nhân viên.	https://audio.tflat.vn/data/cache/images/300x225/g/e/generate1.png	https://audio.tflat.vn/audio/g/e/generate.mp3	Hiring and Training	https://tienganhtflat.com/blog/toeic-words-hiring-and-training	2026-07-24 17:22:34.132489	4
151	be ready for	Verb	Sẵn sàng cho	\N	\N	Thanks to her careful research, the applicant felt that she was ready for the interview with the director of the program.	Nhờ sự nghiên cứu cẩn thận của mình, người xin việc thấy rằng cô ta đã sẵn sàng cho cuộc phỏng vấn với người giám đốc của chương trình.	https://audio.tflat.vn/data/cache/images/300x225/b/e/be_ready_for.jpg	https://audio.tflat.vn/audio/b/e/be_ready_for.mp3	Apply and Interviewing	https://tienganhtflat.com/blog/toeic-words-apply-and-interviewing	2026-07-24 17:22:34.132489	4
...
597	gather	Verb	Tập hợp, tụ thập, thu thập; kết luận, suy ra	/'gæðə/	to come together, or bring people together	We gathered information for our plan from many sources.	Chúng tôi thu thập thông tin cho bản kế hoạch của mình từ nhiều nguồn.	https://audio.tflat.vn/data/cache/images/300x225/g/a/gather1.jpg	https://audio.tflat.vn/audio/g/a/gather.mp3	Business Planning	https://tienganhtflat.com/blog/toeic-words-business-planning	2026-07-24 17:22:34.132489	4
21	lock into	Verb	Ràng buộc chặt, không thể thay đổi	/lɒk ˈɪntʊ/	to commit, to be unable to change	Before you lock yourself into something, check all your options.	Trước khi bạn tự ràng buộc mình vào cái gì, hãy xem xét mọi chọn lựa của mình.	https://audio.tflat.vn/data/cache/images/300x225/l/o/lock_into1.png	https://audio.tflat.vn/audio/l/o/lock_into.mp3	Renting and Leasing	https://tienganhtflat.com/blog/toeic-words-renting-and-leasing	2026-07-24 17:22:34.132489	4
...
497	confirm	Verb	Xác nhận	/kənˈfɜː(r)m/	to state or show that something is definitely true or correct,	Please write to confirm your reservation.	Xin vui lòng viết xác nhận cho việc đặt phòng của bạn.	https://audio.tflat.vn/data/cache/images/300x225/c/o/confirm1.jpg	https://audio.tflat.vn/audio/c/o/confirm.mp3	Hotels	https://tienganhtflat.com/blog/toeic-words-hotels	2026-07-24 17:22:34.132489	4
...
326	fold	Verb	Gập, gấp	/fould/	to bend something, especially paper or cloth	You should fold the omelette in half.	Bạn nên gập trứng rán làm đôi.	https://audio.tflat.vn/data/images_example/300x225/y/o/you_should_ex1_56248d157f8b9a040dc65e74.jpg	https://audio.tflat.vn/audio/f/o/fold.mp3	Correspondence	https://tienganhtflat.com/blog/toeic-words-correspondence	2026-07-24 17:22:34.132489	4
380	sell out	Verb	Hết vé	/'selaut/	to sell all the tickets	The tickets sold out within hours.	Các vé đã được bán hết trong vài giờ.	https://audio.tflat.vn/data/cache/images/300x225/s/e/sell_out1.jpg	https://audio.tflat.vn/audio/s/e/sell_out.mp3	Theater	https://tienganhtflat.com/blog/toeic-words-theater	2026-07-24 17:22:34.132489	4
542	resolve	Verb	Giải quyết	/ri'zɔlv/	to find an acceptable solution to a problem	The manager resolved to clean out all the files at the end of the week.	Cuối tuần, người quản lý đã giải quyết bằng cách xóa sạch tất cả các dữ liệu.	https://audio.tflat.vn/data/cache/images/300x225/r/e/resolve1.png	https://audio.tflat.vn/audio/r/e/resolve.mp3	Contracts	https://tienganhtflat.com/blog/toeic-words-contracts	2026-07-24 17:22:34.132489	4
348	economize	Verb	Tiết kiệm, giảm chi	/i:'kɔnəmaiz/	to use less money, time, etc. than you normally use	My travel agent knows I like to economize and always looks out for the best prices for me.	Người đại lý du lịch của tôi biết tôi thích tiết kiệm và luôn tìm cho tôi giá tốt nhất.	https://audio.tflat.vn/data/cache/images/300x225/e/c/economize1.png	https://audio.tflat.vn/audio/e/c/economize.mp3	Airlines	https://tienganhtflat.com/blog/toeic-words-airlines	2026-07-24 17:22:34.132489	4
...
486	replace	Verb	Thay thế	/ri'pleis/	to be used instead of something / somebody else	My father replaced the old plug with a new one.	Ba tôi thay thế cái nắp cũ bằng cái mới.	https://audio.tflat.vn/data/cache/images/300x225/r/e/replace1.png	https://audio.tflat.vn/audio/r/e/replace.mp3	Electronics	https://tienganhtflat.com/blog/toeic-words-electronics-3	2026-07-24 17:22:34.132489	5
112	acquire	Verb	Đạt được, thu được	/ə'kwaiə/	to gain something by your own efforts	He has acquired a good knowledge of English.	Cậu ấy đã đạt được một kiến thức tốt về tiếng Anh.	https://audio.tflat.vn/data/cache/images/300x225/a/c/acquire1.png	https://audio.tflat.vn/audio/a/c/acquire.mp3	Museums	https://tienganhtflat.com/blog/toeic-words-museums	2026-07-24 17:22:34.132489	5
...
191	influence	Verb	Ảnh hưởng 	/ˈɪnfluəns/	\N	My father was the biggest influence on my character.	Bố tôi là người ảnh hưởng lớn nhất tới tính cách tôi.	https://audio.tflat.vn/data/cache/images/300x225/i/n/influence-v1.jpg	https://audio.tflat.vn/audio/i/n/influence-v.mp3	Movies	https://tienganhtflat.com/blog/toeic-words-movies	2026-07-24 17:22:34.132489	5
...
11	be aware of	Verb	Am hiểu, biết	/bi: ə'weə əv/	to be conscious of	Are you aware of the new employee's past work history?	Anh có biết về lịch sử làm việc trước đây của người nhân viên mới không?	https://audio.tflat.vn/data/cache/images/300x225/b/e/be_aware_of.jpg	https://audio.tflat.vn/audio/b/e/be_aware_of.mp3	Salaries & Benefits	https://tienganhtflat.com/blog/toeic-words-salaries-benefits	2026-07-24 17:22:34.132489	5
...
521	commit	Verb	Gửi, giao, giao phó, ủy nhiệm, ủy thác	/kə'mit/	to promise sincerely that you will definitely do something.	It is a good idea to commit a certain percentage of your income to investments.	Ý tưởng tốt là đem một vài % nào đó thu nhập của bạn để đầu tư.	https://audio.tflat.vn/data/cache/images/300x225/c/o/commit2.jpg	https://audio.tflat.vn/audio/c/o/commit.mp3	Investment	https://tienganhtflat.com/blog/toeic-words-investment	2026-07-24 17:22:34.132489	5
187	continue	Verb	Tiếp tục, duy trì	/kənˈtɪnjuː/	happening without stopping	He continued to ignore everything I was saying.	Anh ta tiếp tục bỏ qua tất cả những gì tôi nói.	https://audio.tflat.vn/data/images_example/300x225/h/e/he_continu_ex1_56248cef7f8b9af60c1430bb.jpg	https://audio.tflat.vn/audio/c/o/continue.mp3	Movies	https://tienganhtflat.com/blog/toeic-words-movies	2026-07-24 17:22:34.132489	5
...
49	suit	Verb	Phù hợp với, thích hợp với	/sju:t/	to be convenient or useful for somebody	I have finally found a health plan that suits my needs.	Rốt cuộc thì tôi đã tìm ra một dự án chăm sóc sức khỏe (mà) phù hợp với nhu cầu của tôi.	https://audio.tflat.vn/data/cache/images/300x225/s/u/suit1.png	https://audio.tflat.vn/audio/s/u/suit.mp3	Health	https://tienganhtflat.com/blog/toeic-words-health	2026-07-24 17:22:34.132489	5
...
90	consume	Verb	Tiêu thụ, tiêu dùng	/kən'sju:m/	to use something, especially fuel, engery or time	People consume a good deal of sugar in drinks.	Mọi người tiêu dùng một lượng đường lớn trong đồ uống.	https://audio.tflat.vn/data/cache/images/300x225/c/o/consume1.png	https://audio.tflat.vn/audio/c/o/consume.mp3	Marketing	https://tienganhtflat.com/blog/toeic-words-marketing	2026-07-24 17:22:34.132489	5
32	repel	Verb	Làm khó chịu	/ri'pel/	to make somebody feel horror or disgust	Faulty products repel repeat customers.	Những sản phẩm lỗi lại gây khó chịu cho khách hàng.	https://audio.tflat.vn/data/cache/images/300x225/r/e/repel2.png	https://audio.tflat.vn/audio/r/e/repel.mp3	Quality Control	https://tienganhtflat.com/blog/toeic-words-quality-control	2026-07-24 17:22:34.132489	5
...
117	fashion	Adjective	Thời trang, mốt	/ˈfæʃn/	a popular style of clothes, hair, etc. at a particular time or place	The museum's classical architecture has never gone out of fashion.	Kiến trúc cổ điển của viện bảo tàng không bao giờ lỗi thời.	https://audio.tflat.vn/data/cache/images/300x225/f/a/fashion1.png	https://audio.tflat.vn/audio/f/a/fashion.mp3	Museums	https://tienganhtflat.com/blog/toeic-words-museums	2026-07-24 17:22:34.132489	1
...
24	subject to	Adjective	Lệ thuộc vào, tùy theo	/ˈsʌbdʒɛkt tuː/	under legal power, dependent	This contract is subject to all the laws and regulations of the state.	Hợp đồng này tuân thủ mọi luật lệ và nguyên tắc của nhà nước.	https://audio.tflat.vn/data/cache/images/300x225/s/u/subject_to1.jpg	https://audio.tflat.vn/audio/s/u/subject_to.mp3	Renting and Leasing	https://tienganhtflat.com/blog/toeic-words-renting-and-leasing	2026-07-24 17:22:34.132489	1
...
560	familiar	Adjective	Quen thuộc, thông thường	/fə'miljə/	well known to you	It's nice to see some familiar items on the menu.	Thật là hay khi thấy vài món ăn quen thuộc trong thực đơn.	https://audio.tflat.vn/data/cache/images/300x225/f/a/familiar2.jpg	https://audio.tflat.vn/audio/f/a/familiar.mp3	Selecting A Restaurant	https://tienganhtflat.com/blog/toeic-words-selecting-a-restaurant	2026-07-24 17:22:34.132489	1
349	equivalent	Adjective	Tương đương	/i'kwivələnt/	equal in value, amount, meaning, importance, etc.	The food the airline serves in business class is equivalent to that served in first class.	Đồ ăn mà hãng hàng không phục vụ cho vé hạng thường thì tương đương với đồ ăn được phục vụ cho vé hạng nhất.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_food_t_ex1_56248d167f8b9a040dc66170.png	https://audio.tflat.vn/audio/e/q/equivalent.mp3	Airlines	https://tienganhtflat.com/blog/toeic-words-airlines	2026-07-24 17:22:34.132489	1
459	disparate	Adjective	Hoàn toàn khác nhau	/'dispərit/	made up of parts or people that are very different from each other	Religious song cut across disparate categories of music.	Bài hát tôn giáo (thánh ca) tách hẳn ra làm thể loại âm nhạc khác biệt.	https://audio.tflat.vn/data/cache/images/300x225/d/i/disparate1.png	https://audio.tflat.vn/audio/d/i/disparate.mp3	Music	https://tienganhtflat.com/blog/toeic-words-music	2026-07-24 17:22:34.132489	1
...
31	perceptive	Adjective	Nhận thức được, cảm giác được, cảm thụ được	/pə'septiv/	having or showing the ability to see or understand things quickly, especially things that are not obvious	It takes a perceptive person to be a good manager.	Phải là một người có khả năng cảm nhận mới trở thành một nhà quản lý tốt.	https://audio.tflat.vn/data/cache/images/300x225/p/e/perceptive2.png	https://audio.tflat.vn/audio/p/e/perceptive.mp3	Quality Control	https://tienganhtflat.com/blog/toeic-words-quality-control	2026-07-24 17:22:34.132489	1
...
81	prerequisite	Adjective	(điều/điều kiện) tiên quyết, cần trước hết, đòi hỏi trước hết	/'pri:'rekwizit/	something that must exist or happen before something else can happen or be done	Here are the prerequisites that you need to purchase before coming to class.	Đây là những thứ đòi hỏi trước hết mà bạn cần phải sắm trước khi vào lớp học.	https://audio.tflat.vn/data/images_example/300x225/h/e/here_are_t_ex1_580de4687f8b9a84688b459f.jpg	https://audio.tflat.vn/audio/p/r/prerequisite.mp3	Ordering Supplies	https://tienganhtflat.com/blog/toeic-words-ordering-supplies	2026-07-24 17:22:34.132489	1
...
121	significant	Adjective	Có tầm quan trọng, đáng kể	/sig'nifikənt/	large or important enough to have an effect or to be noticed	There has been a significant increase in the number of women students in recent years.	Số lượng sinh viên nữ đã tăng đáng kể trong những năm gần đây.	https://audio.tflat.vn/data/cache/images/300x225/s/i/significant1.png	https://audio.tflat.vn/audio/s/i/significant.mp3	Museums	https://tienganhtflat.com/blog/toeic-words-museums	2026-07-24 17:22:34.132489	1
77	everyday	Adjective	Hàng ngày, thường ngày, thông thường	/'evridei/	routine, common	This everyday routine of having to check inventory is boring.	Công việc thường ngày phải kiểm tra hàng tồn kho thì thật chán.	https://audio.tflat.vn/data/cache/images/300x225/e/v/everyday1.jpg	https://audio.tflat.vn/audio/e/v/everyday.mp3	Ordering Supplies	https://tienganhtflat.com/blog/toeic-words-ordering-supplies	2026-07-24 17:22:34.132489	1
411	commensurate	Adjective	(+with) xứng với, tương xứng với	/kə'menʃərit/	matching something in size, importance, quality	Generally the first year's salary is commensurate with experience and education level.	Nói chung thì tiền lương năm đầu tiên tương xứng với kinh nghiệm và trình độ học vấn.	https://audio.tflat.vn/data/cache/images/300x225/c/o/commensurate.jpg	https://audio.tflat.vn/audio/c/o/commensurate.mp3	Job Ads & Recruitment	https://tienganhtflat.com/blog/toeic-words-job-ads-recruitment	2026-07-24 17:22:34.132489	2
925	mandatory	Adjective	bắt buộc	/ˈmændətɔːri/	required	Attendance is mandatory.	Việc tham dự là bắt buộc.	\N	\N	Human Resources	\N	2026-07-24 18:01:26.486905	1
180	outdated	Adjective	Hết hạn; lỗi thời, lạc hậu, cổ, hiện nay không còn dùng (obsolete)	/aut'deitid/	not currently in use	Before you do a mailing, make sure that none of the addresses is outdated.	Trước khi anh gửi thư, hãy bảo đảm rằng không có địa chỉ nào hiện không còn sử dụng	https://audio.tflat.vn/data/cache/images/300x225/o/u/outdated1.jpg	https://audio.tflat.vn/audio/o/u/outdated.mp3	Office Procedures	https://tienganhtflat.com/blog/toeic-words-office-procedures	2026-07-24 17:22:34.132489	2
...
353	prospective	Adjective	(thuộc) tương lai, triển vọng; về sau, sắp tới	/prəˈspektɪv/	expected to do something or to become something	I narrowed my list of prospective destinations to my three top choices.	Tôi rút gọn danh sách các điểm đến triển vọng đối với tôi xuống còn 3 chọn lựa.	https://audio.tflat.vn/data/cache/images/300x225/p/r/prospective.jpg	https://audio.tflat.vn/audio/p/r/prospective.mp3	Airlines	https://tienganhtflat.com/blog/toeic-words-airlines	2026-07-24 17:22:34.132489	2
...
469	comprehensive	Adjective	Bao hàm, toàn diện	/,kɔmpri'hensiv/	including all, or almost all, the items, details, facts, information, etc., that may be concerned	Our travel agent gave us a comprehensive travel package, including rail passes.	Người đại lý du lịch của chúng tôi trao cho một gói du lịch toàn diện, kể cả đi tàu lửa.	https://audio.tflat.vn/data/cache/images/300x225/c/o/comprehensive2.jpg	https://audio.tflat.vn/audio/c/o/comprehensive.mp3	Trains	https://tienganhtflat.com/blog/toeic-words-trains	2026-07-24 17:22:34.132489	2
276	lengthy	Adjective	Lâu, dài, dài dòng	/'leɳθi/	very long, and often too long, in time or size	After lengthy discussions, the chairperson was reelected for another term.	Sau những cuộc tranh luận dài, vị chủ tịch đã được bầu lại một nhiệm kỳ nữa.	https://audio.tflat.vn/data/cache/images/300x225/l/e/lengthy2.png	https://audio.tflat.vn/audio/l/e/lengthy.mp3	Board Meeting & Committees	https://tienganhtflat.com/blog/toeic-words-board-meeting-committees	2026-07-24 17:22:34.132489	2
...
494	advanced	Adjective	Tiên tiến	/ədˈvɑːnst/	having the most modern and recently developed ideas, methods, etc.	Since the hotel installed an advanced computer system, all operations have been functioning more smoothly.	Bởi vì khách sạn đã lắp đặt một hệ thống máy tính tiên tiến, mọi hoạt động đang được vận hành trơn tru.	https://audio.tflat.vn/data/cache/images/300x225/a/d/advanced1.jpg	https://audio.tflat.vn/audio/a/d/advanced.mp3	Hotels	https://tienganhtflat.com/blog/toeic-words-hotels	2026-07-24 17:22:34.132489	2
...
160	adjacent	Adjective	Kế bên, liền kề, sát cạnh	/ə'dʤeizənt/	next to or near something	My office is adjacent to the receptionist area on the third floor.	Văn phòng của tôi ở bên cạnh khu vực tiếp tân ở tầng ba.	https://audio.tflat.vn/data/cache/images/300x225/a/d/adjacent2.png	https://audio.tflat.vn/audio/a/d/adjacent.mp3	Property & Departments	https://tienganhtflat.com/blog/toeic-words-property-departments	2026-07-24 17:22:34.132489	2
582	convenient	Adjective	Thuận tiện	/kənˈviːniənt/	useful, easy, or quick to do; not causing problems	Living here is so convenient – everything I need is just 5 minutes away.	Sống ở đây thật thuận tiện – mọi thứ mình cần chỉ cách 5 phút.	https://audio.tflat.vn/data/cache/images/300x225/c/o/convenient1.jpg	https://audio.tflat.vn/audio/c/o/convenient.mp3	Pharmacy	https://tienganhtflat.com/blog/toeic-words-pharmacy	2026-07-24 17:22:34.132489	2
252	logical	Adjective	Có lô-gic, hợp lý	/ˈlɒdʒɪk(ə)l/	seeming natural, reasonable. or sensible	Your argument is not logical at all.	Lập luận của bạn là không hợp lý ở tất cả.	https://audio.tflat.vn/data/cache/images/300x225/l/o/logical2.png	https://audio.tflat.vn/audio/l/o/logical.mp3	Product Development	https://tienganhtflat.com/blog/toeic-words-product-development	2026-07-24 17:22:34.132489	2
...
456	available	Adjective	Có sẵn, sẵn sàng	/əˈveɪləbl/	that you can get, buy, or find	This was the only room available.	Đây là căn phòng duy nhất có sẵn.	https://audio.tflat.vn/data/images_example/300x225/t/h/this_was_t_ex1_56248d007f8b9afc0c298119.jpg	https://audio.tflat.vn/audio/a/v/available.mp3	Music	https://tienganhtflat.com/blog/toeic-words-music	2026-07-24 17:22:34.132489	2
290	in-depth	Adjective	Cẩn thận, tỉ mỉ, chu đáo, chi tiết	/ɪn dɛpθ/	very thorough and detailed	The newspaper gave in-depth coverage of the tragic bombing.	Tờ báo đưa tin chi tiết về vụ ném bom bi thảm.	https://audio.tflat.vn/data/cache/images/300x225/i/n/in-depth.jpg	https://audio.tflat.vn/audio/i/n/in-depth.mp3	Media	https://tienganhtflat.com/blog/toeic-words-media	2026-07-24 17:22:34.132489	3
83	smooth	Adjective	Hòa nhã, lễ độ	/smu:ð/	completely flat and even, without any lumps, holes, or rough areas	Her smooth manner won her the appreciation of the manager but not her colleagues.	Thái độ hòa nhã của cô ta đã thu được sự đánh giá cao của giám đốc, nhưng không (thu phục) được đồng nghiệp.	https://audio.tflat.vn/data/cache/images/300x225/s/m/smooth1.jpg	https://audio.tflat.vn/audio/s/m/smooth.mp3	Ordering Supplies	https://tienganhtflat.com/blog/toeic-words-ordering-supplies	2026-07-24 17:22:34.132489	3
131	nervously	Adjective	Bồn chồn, lo lắng	/ˈnɜːvəsli/	anxious about something or afraid of something	As we approached the city Lonnie started driving nervously, so I volunteered to drive that part of the trip.	Lúc mà chúng tôi đến thành phố thì Lonnie bắt đầu lái xe rất căng thẳng, vì vậy tôi tình nguyện lái đoạn đường đó của cuộc hành trình.	https://audio.tflat.vn/data/cache/images/300x225/n/e/nervously1.png	https://audio.tflat.vn/audio/n/e/nervously.mp3	Car Rentals	https://tienganhtflat.com/blog/toeic-words-car-rentals	2026-07-24 17:22:34.132489	3
602	strong	Adjective	Khỏe, mạnh, tốt, bền, kiên cố; đanh thép, kiên quyết; sôi nổi, nhiệt tình...	/strɔɳ/	having a lot of physical power	That boy is very strong.	Cậu bé đó là rất mạnh mẽ.	https://audio.tflat.vn/data/cache/images/300x225/s/t/strong1.jpg	https://audio.tflat.vn/audio/s/t/strong.mp3	Business Planning	https://tienganhtflat.com/blog/toeic-words-business-planning	2026-07-24 17:22:34.132489	3
97	productive	Adjective	Có năng suất, hiệu quả 	/prəˈdʌktɪv/	making goods or growing crops, especially in large quantities	The managers had a very productive meeting and were able to solve many of the problems.	Người trưởng phòng có một cuộc họp rất hiệu quả và đã có thể làm sáng tỏ nhiều vấn đề.	https://audio.tflat.vn/data/cache/images/300x225/p/r/productive1.png	https://audio.tflat.vn/audio/p/r/productive.mp3	Marketing	https://tienganhtflat.com/blog/toeic-words-marketing	2026-07-24 17:22:34.132489	3
...
341	multiple	Adjective	Nhiều, bội số	/'mʌltipl/	many in number; involving many different people or things	a house in multiple ownership/occupancy (= owned/occupied by several different people or families)	căn nhà thuộc nhiều người sở hữu	https://audio.tflat.vn/data/cache/images/300x225/m/u/multiple1.png	https://audio.tflat.vn/audio/m/u/multiple.mp3	Ordering Lunch	https://tienganhtflat.com/blog/toeic-words-ordering-lunch	2026-07-24 17:22:34.132489	3
...
246	anxious	Adjective	Lo lắng, băn khoăn	/'æɳkʃəs/	feeling worried or nervous	He seemed anxious about the meeting.	Anh ta có vẻ lo lắng về cuộc họp.	https://audio.tflat.vn/data/cache/images/300x225/a/n/anxious1.png	https://audio.tflat.vn/audio/a/n/anxious.mp3	Product Development	https://tienganhtflat.com/blog/toeic-words-product-development	2026-07-24 17:22:34.132489	3
488	sharp	Adjective	 thông minh, láu lỉnh	/ʃɑ:p/	sudden and rapid, especially of a change in something	The new employee proved how sharp she was when she mastered the new program in a few days.	Nhân viên mới đã chứng tỏ được cô ấy thông minh đến thế nào khi mà cô đã làm chủ được chương trình mới trong vài ngày.	https://audio.tflat.vn/data/cache/images/300x225/s/h/sharp2.jpg	https://audio.tflat.vn/audio/s/h/sharp.mp3	Electronics	https://tienganhtflat.com/blog/toeic-words-electronics-3	2026-07-24 17:22:34.132489	3
294	thorough	Adjective	Kỹ lưỡng, tỉ mỉ	/'θʌrə/	done completely; with great attention to detail	The story was the result of thorough research.	Bài báo là kết quả của sự nghiên cứu kỹ lưỡng.	https://audio.tflat.vn/data/cache/images/300x225/t/h/thorough1.png	https://audio.tflat.vn/audio/t/h/thorough.mp3	Media	https://tienganhtflat.com/blog/toeic-words-media	2026-07-24 17:22:34.132489	4
...
262	evident	Adjective	Hiển nhiên, rõ ràng	/'evidənt/	clear; easily seen	The presence of a wisdom tooth was not evident until the dentist started to examine the patient.	Sự có mặt của cái răng khôn thì không rõ ràng cho đến khi nha sĩ bắt đầu khám bệnh nhân.	https://audio.tflat.vn/data/cache/images/300x225/e/v/evident1.png	https://audio.tflat.vn/audio/e/v/evident.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	4
285	constantly	Adjective	Luôn luôn, liên tục, liên miên	/'kɔnstəntli/	all the time; repeatedly	The company is constantly looking for highly trained employees.	Công ty không ngừng tìm kiếm những nhân viên được đào tạo tốt.	https://audio.tflat.vn/data/cache/images/300x225/c/o/constantly1.jpg	https://audio.tflat.vn/audio/c/o/constantly.mp3	Media	https://tienganhtflat.com/blog/toeic-words-media	2026-07-24 17:22:34.132489	5
578	tedious	Adjective	Chán ngắt, tẻ nhạt, nhạt nhẽo, buồn tẻ	/'ti:djəs/	lasting or taking too long and not interesting	Counting merchandise all weekend is the most tedious job I can imagine.	Kiểm đếm hàng suốt kỳ nghỉ cuối tuần là một công việc tẻ nhạt nhất tôi có thể hình dung.	https://audio.tflat.vn/data/cache/images/300x225/t/e/tedious1.png	https://audio.tflat.vn/audio/t/e/tedious.mp3	Inventory	https://tienganhtflat.com/blog/toeic-words-inventory	2026-07-24 17:22:34.132489	5
...
480	remote	Adjective	Xa xôi, hẻo lánh	/rɪˈməʊt/	far away from places where other people live	We took the train out of the city and found a remote hotel in the country for the weekend.	Chúng tôi đón xe lửa ra khỏi thành phố và tìm một khách sạn cách biệt ở miền quê vào dịp cuối tuần.	https://audio.tflat.vn/data/cache/images/300x225/r/e/remote2.png	https://audio.tflat.vn/audio/r/e/remote.mp3	Trains	https://tienganhtflat.com/blog/toeic-words-trains	2026-07-24 17:22:34.132489	5
325	express	Adjective	Nhanh, hỏa tốc, tốc hành.	/iks'pres/	fast and direct	It's important that this document be there tomorrow, so please send it express mail.	Việc tài liệu này phải có ở chổ ngày mai vì nó rất quan trọng, do đó nên hãy gửi thư chuyển phát nhanh.	https://audio.tflat.vn/data/cache/images/300x225/e/x/express1.png	https://audio.tflat.vn/audio/e/x/express.mp3	Correspondence	https://tienganhtflat.com/blog/toeic-words-correspondence	2026-07-24 17:22:34.132489	5
525	long-term	Adjective	Dài hạn, dài ngày, lâu dài	/'lɔɳtə:m/	involing long time period.	The CEO's long-term goal was to increase the return on investment.	Mục tiêu dài hạn của giám đốc điều hành (CEO) là gia tăng tiền lãi thu về từ việc đầu tư.	https://audio.tflat.vn/data/cache/images/300x225/l/o/long-term1.png	https://audio.tflat.vn/audio/l/o/long-term.mp3	Investment	https://tienganhtflat.com/blog/toeic-words-investment	2026-07-24 17:22:34.132489	5
514	restricted	Adjective	Bị hạn chế, bị giới hạn	/ris'triktid/	limited or small in size or amount	Access to the safe deposit box vault is restricted to key holders.	Việc vào hầm két bạc được hạn chế trong những người giữ chìa khóa.	https://audio.tflat.vn/data/cache/images/300x225/r/e/restricted1.png	https://audio.tflat.vn/audio/r/e/restricted.mp3	Banking	https://tienganhtflat.com/blog/toeic-words-banking	2026-07-24 17:22:34.132489	5
...
392	serious	Adjective	Nghiêm túc	/'siəriəs/	bad or dangerous	We are always serious when working.	Chúng tôi luôn nghiêm túc khi làm việc.	https://audio.tflat.vn/data/cache/images/300x225/s/e/serious1.png	https://audio.tflat.vn/audio/s/e/serious.mp3	Doctor's Office	https://tienganhtflat.com/blog/toeic-words-doctor-s-office	2026-07-24 17:22:34.132489	5
548	overall	Adjective	Toàn bộ, toàn thể, tất cả; nói chung	/'ouvərɔ:l/	general	The person with overall responsibility for the project.	Người chịu trách nhiệm toàn bộ cho dự án.	https://audio.tflat.vn/data/cache/images/300x225/o/v/overall1.png	https://audio.tflat.vn/audio/o/v/overall.mp3	Financial Statements	https://tienganhtflat.com/blog/toeic-words-financial-statements	2026-07-24 17:22:34.132489	5
...
146	randomly	Adverb	Ngẫu nhiên, tình cờ	/['rændəmli]/	done, without somebody deciding in advance what is going to happen, or without any regular pattern	We randomly made our selections from the menu.	Chúng tôi chọn đại (các món ăn) từ thực đơn.	https://audio.tflat.vn/data/cache/images/300x225/r/a/randomly1.png	https://audio.tflat.vn/audio/r/a/randomly.mp3	Eating Out	https://tienganhtflat.com/blog/toeic-words-eating-out	2026-07-24 17:22:34.132489	1
239	frequently	Adverb	Thường xuyên, một cách thường xuyên	/ˈfriːkwəntli/	often	Appliances frequently come with a one-year warranty.	Trang thiết bị thường có bảo hành một năm.	https://audio.tflat.vn/data/cache/images/300x225/f/r/frequently1.jpeg	https://audio.tflat.vn/audio/f/r/frequently.mp3	Warranties	https://tienganhtflat.com/blog/toeic-words-warranties	2026-07-24 17:22:34.132489	1
92	currently	Adverb	Hiện tại, lúc này	/ˈkʌrəntli/	at the present time	Currently, customers are demanding big discounts for bulk orders.	Hiện nay, khách hàng đang đòi hỏi những khoản giảm giá nhiều cho những đơn hàng lớn.	https://audio.tflat.vn/data/images_example/300x225/c/u/currently__ex1_56248d0c7f8b9a000de3d039.jpg	https://audio.tflat.vn/audio/c/u/currently.mp3	Marketing	https://tienganhtflat.com/blog/toeic-words-marketing	2026-07-24 17:22:34.132489	1
6	flexibly	Adverb	‹một cách› mềm dẻo, linh hoạt, linh động	/ˈfleksəbl/	able to change to suit new conditions or situations	My manager thinks flexibly, enabling herself to solve many sticky problems.	Trưởng phòng của tôi suy nghĩ linh hoạt, cho phép bà tự giải quyết nhiều vấn đề khó chịu.	https://audio.tflat.vn/data/cache/images/300x225/f/l/flexibly.jpg	https://audio.tflat.vn/audio/f/l/flexibly.mp3	Salaries & Benefits	https://tienganhtflat.com/blog/toeic-words-salaries-benefits	2026-07-24 17:22:34.132489	1
509	cautiously	Adverb	‹một cách› thận trọng, cẩn thận	/ˈkɔːʃəsli/	being careful about what you say or do	Act cautiously when signing contracts and read them thoroughly first.	Hành động thận trọng khi ký các hợp đồng và trước hết hãy đọc chúng kỹ lưỡng.	https://audio.tflat.vn/data/cache/images/300x225/c/a/cautiously1.png	https://audio.tflat.vn/audio/c/a/cautiously.mp3	Banking	https://tienganhtflat.com/blog/toeic-words-banking	2026-07-24 17:22:34.132489	1
357	accurately	Adverb	‹một cách› chính xác, đúng đắn, xác đáng	/ˈækjərət/	correct and true in every detail	The teacher evaluates student's ability accurately.	Giáo viên đánh giá chính xác khả năng của học sinh. 	https://audio.tflat.vn/data/images_example/300x225/t/h/the_teache_ex1_56248d157f8b9a040dc65f30.jpg	https://audio.tflat.vn/audio/a/c/accurately.mp3	Shipping	https://tienganhtflat.com/blog/toeic-words-shipping	2026-07-24 17:22:34.132489	1
569	automatically	Adverb	‹một cách› tự động	/ˌɔːtəˈmætɪkli/	having controls that work without needing a person to operate them	The door opens automatically.	Cửa mở một cách tự động.	https://audio.tflat.vn/data/cache/images/300x225/a/u/automatically1.jpg	https://audio.tflat.vn/audio/a/u/automatically.mp3	Inventory	https://tienganhtflat.com/blog/toeic-words-inventory	2026-07-24 17:22:34.132489	2
195	separately	Adverb	Một cách riêng biệt	/'seprətli/	as a separate person or thing; not together	The theater was very crowded so we had to sit separately.	Rạp hát rất đông nên chúng tôi phải ngồi riêng rẽ.	https://audio.tflat.vn/data/cache/images/300x225/s/e/separately1.png	https://audio.tflat.vn/audio/s/e/separately.mp3	Movies	https://tienganhtflat.com/blog/toeic-words-movies	2026-07-24 17:22:34.132489	2
51	as needed	Adverb	Lúc cần thiết	/az niːdɪd/	In need	The service contract states that repairs will be made on a basis as needed.	Hợp đồng dịch vụ nói rằng việc sửa chữa sẽ được thực hiện dựa trên cơ sở lúc cần thiết.	https://audio.tflat.vn/data/cache/images/300x225/a/s/as_needed2.jpg	https://audio.tflat.vn/audio/a/s/as_needed.mp3	Office Technology	https://tienganhtflat.com/blog/toeic-words-office-technology	2026-07-24 17:22:34.132489	2
559	daringly	Adverb	Táo bạo, cả gan, phiêu lưu, dũng cảm (bravely)	/ˈdeərɪŋli/	brave; willing to do dangerous	We daringly ordered the raw squid.	Chúng tôi cả gan gọi món mực sống.	https://audio.tflat.vn/data/images_example/300x225/w/e/we_daringl_ex1_580ec4a47f8b9a0e898b4567.jpg	https://audio.tflat.vn/audio/d/a/daringly.mp3	Selecting A Restaurant	https://tienganhtflat.com/blog/toeic-words-selecting-a-restaurant	2026-07-24 17:22:34.132489	2
4	delicately	Adverb	‹một cách› tinh vi, tế nhị, lịch thiệp	/ˈdelɪkət/	easily damaged or broken	The manager delicately asked about the health of his client.	Người trưởng phòng tế nhị hỏi thăm sức khỏe khách hàng của anh ta.	https://audio.tflat.vn/data/cache/images/300x225/d/e/delicately1.jpg	https://audio.tflat.vn/audio/d/e/delicately.mp3	Salaries & Benefits	https://tienganhtflat.com/blog/toeic-words-salaries-benefits	2026-07-24 17:22:34.132489	2
554	typically	Adverb	Tiêu biểu, điển hình	/ˈtɪpɪkli/	used to say that something usually happens in the way that you are stating	Office expenses typically include such things as salaries, rent, and office supplies.	Các chi phí văn phòng bao gồm tiêu biểu những thứ như là: tiền lương, tiền thuê và đồ dùng dự trữ văn phòng.	https://audio.tflat.vn/data/cache/images/300x225/t/y/typically1.png	https://audio.tflat.vn/audio/t/y/typically.mp3	Financial Statements	https://tienganhtflat.com/blog/toeic-words-financial-statements	2026-07-24 17:22:34.132489	2
399	ideally	Adverb	Một cách lý tưởng	/ai'diəli/	perfect; most suitable	The location for the concert would ideally have plenty of parking.	Chỗ địa điểm cho buổi hòa nhạc lý tưởng nên có nhiều chỗ đậu xe.	https://audio.tflat.vn/data/cache/images/300x225/i/d/ideally1.jpg	https://audio.tflat.vn/audio/i/d/ideally.mp3	Events	https://tienganhtflat.com/blog/toeic-words-events	2026-07-24 17:22:34.132489	2
318	profitably	Adverb	Có lợi, có ích, sinh lãi, sinh lợi	/ˌprɒfɪtəˈbɪləti/	that makes or is likely to make money.	We invested in the stock market profitably.	Công ty đã đầu tư sinh lợi vào thị trường chứng khoán.	https://audio.tflat.vn/data/cache/images/300x225/p/r/profitably1.jpg	https://audio.tflat.vn/audio/p/r/profitably.mp3	Accounting	https://tienganhtflat.com/blog/toeic-words-accounting	2026-07-24 17:22:34.132489	2
478	relatively	Adverb	Tương đối	/'relətivli/	to a fairly large degree	The train is relatively empty for this time of day.	Đoàn tàu hơi vắng khách vào lúc này trong ngày.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_train__ex1_56248d167f8b9a040dc661a8.jpg	https://audio.tflat.vn/audio/r/e/relatively.mp3	Trains	https://tienganhtflat.com/blog/toeic-words-trains	2026-07-24 17:22:34.132489	3
47	regardless	Adverb	Không quan tâm, bất chấp	/ri'gɑ:dlis/	paying no attention, even if the situation is bad or there are difficulties	Regardless of the cost, we all need health insurance.	Bất chấp phí tổn, tất cả chúng tôi đều cần bảo hiểm y tế.	https://audio.tflat.vn/data/cache/images/300x225/r/e/regardless1.png	https://audio.tflat.vn/audio/r/e/regardless.mp3	Health	https://tienganhtflat.com/blog/toeic-words-health	2026-07-24 17:22:34.132489	3
268	regularly	Adverb	Thường xuyên	/ˈreɡjələli/	at regular intervals or times	Doing physical exercise regularly will make you healthy.	Tập thể dục thường xuyên sẽ làm cho bạn khỏe mạnh.	https://audio.tflat.vn/data/cache/images/300x225/r/e/regularly1.png	https://audio.tflat.vn/audio/r/e/regularly.mp3	Dentist's Office	https://tienganhtflat.com/blog/toeic-words-dentist-s-office	2026-07-24 17:22:34.132489	3
76	essentially	Adverb	Về cơ bản	/ɪˈsenʃəli/	when you think about the true, important, or basic nature of someone or something	He was, essentially, a teacher, not a manager.	Về cơ bản thì anh ấy như là 1 giáo viên chứ không phải người quản lý.	https://audio.tflat.vn/data/cache/images/300x225/e/s/essentially1.jpg	https://audio.tflat.vn/audio/e/s/essentially.mp3	Ordering Supplies	https://tienganhtflat.com/blog/toeic-words-ordering-supplies	2026-07-24 17:22:34.132489	3
599	primarily	Adverb	Trước hết, đầu tiên; chính, chủ yếu, quan trọng nhất	/'praimərili/	mainly	The developers are thinking primarily of how to enter the South American market.	Những nhà phát triển quan tâm nhất đến việc làm sao để xâm nhập thị trường Nam Mỹ.	https://audio.tflat.vn/data/cache/images/300x225/p/r/primarily1.jpg	https://audio.tflat.vn/audio/p/r/primarily.mp3	Business Planning	https://tienganhtflat.com/blog/toeic-words-business-planning	2026-07-24 17:22:34.132489	3
278	periodically	Adverb	Định kỳ, thường kỳ, chu kỳ	/ˌpɪəriˈɒdɪkli/	happening fairly often and regularly	The group tried to meet periodically.	Nhóm đã cố gắng gặp gỡ định kỳ.	https://audio.tflat.vn/data/cache/images/300x225/p/e/periodically1.jpg	https://audio.tflat.vn/audio/p/e/periodically.mp3	Board Meeting & Committees	https://tienganhtflat.com/blog/toeic-words-board-meeting-committees	2026-07-24 17:22:34.132489	3
381	annually	Adverb	Hàng năm, từng nằm, thường niên (yearly)	/'ænjuəli/	once a year	Everyone should get a physical exam annually.	Mọi người nên đi khám sức khỏe hàng năm.	https://audio.tflat.vn/data/cache/images/300x225/a/n/annually2.jpg	https://audio.tflat.vn/audio/a/n/annually.mp3	Doctor's Office	https://tienganhtflat.com/blog/toeic-words-doctor-s-office	2026-07-24 17:22:34.132489	3
367	sufficiently	Adverb	Đủ, có đủ	/səˈfɪʃnt/	enough for a particular purpose; as much as you need	Two stars are sufficiently close together.	Hai ngôi sao đủ gần nhau. 	https://audio.tflat.vn/data/images_example/300x225/t/w/two_stars__ex1_580de46a7f8b9a84688b45a4.jpg	https://audio.tflat.vn/audio/s/u/sufficiently.mp3	Shipping	https://tienganhtflat.com/blog/toeic-words-shipping	2026-07-24 17:22:34.132489	3
441	strictly	Adverb	‹một cách› nghiêm ngặt, nghiêm khắc	/ˈstrɪktli/	with a lot of control and rules that must be obeyed	Our store strictly enforces its return policy.	Cửa hàng chúng tôi thực thi nghiêm ngặt chính sách hoàn trả hàng của mình.	https://audio.tflat.vn/data/cache/images/300x225/s/t/strictly1.png	https://audio.tflat.vn/audio/s/t/strictly.mp3	Shopping	https://tienganhtflat.com/blog/toeic-words-shopping	2026-07-24 17:22:34.132489	3
159	weakly	Adverb	Một cách yếu ớt, yếu, ốm yếu	/'wi:kli/	in a weak way	Her hands trembled and she spoke weakly at the interview.	Tay cô ta run và cô ta nói giọng yếu ớt tại buổi phỏng vấn.	https://audio.tflat.vn/data/cache/images/300x225/w/e/weakly1.png	https://audio.tflat.vn/audio/w/e/weakly.mp3	Apply and Interviewing	https://tienganhtflat.com/blog/toeic-words-apply-and-interviewing	2026-07-24 17:22:34.132489	4
175	casually	Adverb	Bình thường, không trịnh trọng	/ˈkæʒuəli/	not showing much care or throught	On Fridays, most employees dress casually.	Vào các thứ Sáu, phần lớn nhân viên ăn mặc tùy ý (không mặc đồng phục).	https://audio.tflat.vn/data/cache/images/300x225/c/a/casually1.png	https://audio.tflat.vn/audio/c/a/casually.mp3	Office Procedures	https://tienganhtflat.com/blog/toeic-words-office-procedures	2026-07-24 17:22:34.132489	4
492	technically	Adverb	Nói đến/nói về mặt kỹ thuật; một cách chuyên môn/nghiêm túc	/ˈteknɪkli/	in a way that is connected with the skills needed for a particular job	Technically speaking, the virus infected only script files.	Nói về mặt kỹ thuật thì virus chỉ tác động lên các tập tin script (tập tin kịch bản thi hành).	https://audio.tflat.vn/data/cache/images/300x225/t/e/technically.jpg	https://audio.tflat.vn/audio/t/e/technically.mp3	Electronics	https://tienganhtflat.com/blog/toeic-words-electronics-3	2026-07-24 17:22:34.132489	4
355	substantially	Adverb	Về thực chất, về bản chất, về cơ bản; lớn lao, đáng kể	/səb'stænʃəli/	very much; a lot	The airline I work for had a substantially higher rating for customer satisfaction than our competitors had.	Hãng hàng không mà tôi đang làm việc có thứ hạng về sự hài lòng của khách hàng cao hơn đáng kể thứ hạng mà các đối thủ có.	https://audio.tflat.vn/data/cache/images/300x225/s/u/substantially2.jpg	https://audio.tflat.vn/audio/s/u/substantially.mp3	Airlines	https://tienganhtflat.com/blog/toeic-words-airlines	2026-07-24 17:22:34.132489	4
604	achievement	Noun	Thành tích, thành tựu	/ə'tʃi:vmənt/	a thing that somebody has done successfully, especially using their own effort and skill	He has gained a lot of achievements in the last year.	Anh ấy đã đạt được khá nhiều thành tích trong năm vừa qua.	https://audio.tflat.vn/data/cache/images/300x225/a/c/achievement1.png	https://audio.tflat.vn/audio/a/c/achievement.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	2
606	dedication	Noun	‹sự› cống hiến, hiến dâng, tận tâm, tận tụy	/,dedi'keiʃn/	the hard work and effort that somebody puts into an activity or purpose	The director's dedication to a high-quality product has motivated many of his employees.	Sự cống hiến của giám đốc cho một sản phẩm chất lượng cao đã thúc đẩy nhiều nhân viên.	https://audio.tflat.vn/data/cache/images/300x225/d/e/dedication1.jpg	https://audio.tflat.vn/audio/d/e/dedication.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	4
610	merit	Noun	Công lao, công trạng	/'merit/	the quality of being good and of deserving praise	Employees are evaluated on their merit and not on seniority.	Nhân viên được đánh giá theo công lao của họ và không theo thâm niên.	https://audio.tflat.vn/data/cache/images/300x225/m/e/merit1.jpg	https://audio.tflat.vn/audio/m/e/merit.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	5
614	recognition	Noun	Sự ghi nhận, sự công nhận	/,rekəg'niʃn/	the act of accepting that something exists, is true or is official	She received recognition for her work.	Cô ấy đã có được sự ghi nhận cho những việc cô ấy đã làm.	https://audio.tflat.vn/data/cache/images/300x225/r/e/recognition1.jpg	https://audio.tflat.vn/audio/r/e/recognition.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	5
608	look to	Verb	Tin vào, trông cậy vào, mong đợi ở (ai)	/lʊk tuː/	to depend on, to rely on	They look to their supervisor for guidance and direction.	Họ trông cậy vào người giám sát của họ về sự chỉ đạo và hướng dẫn.	https://audio.tflat.vn/data/cache/images/300x225/l/o/look_to1.jpg	https://audio.tflat.vn/audio/l/o/look_to.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	1
615	value	Verb	Đánh giá, định giá	/'vælju:/	to think that somebody / something is important	The expert valued the text at $7,000.	Chuyên gia đã định giá nguyên bản/cuốn sách là 7 ngàn đô-la.	https://audio.tflat.vn/data/cache/images/300x225/v/a/value1.jpg	https://audio.tflat.vn/audio/v/a/value.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	2
613	promote	Verb	Khuyến khích, đẩy mạnh, làm tăng thêm	/prəˈməʊt/	to move somebody to a higher rank or more senior job	The youth club in my neighbourhood works to promote awareness of the dangers that threaten our environment.	Câu lạc bộ thanh niên ở vùng tôi hoạt động để tăng thêm nhận thức về những nguy hiểm đe dọa môi trường của chúng ta.	https://audio.tflat.vn/data/images_example/300x225/t/h/the_youth__ex1_56248d157f8b9a040dc65ef4.jpg	https://audio.tflat.vn/audio/p/r/promote.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	2
605	contribute	Verb	Đóng góp	/kən'tribju:t/	to give something, especially money or goods, to help somebody	Do you contribute anything to this charity?	Bạn có đóng góp gì cho buổi từ thiện này không?	https://audio.tflat.vn/data/cache/images/300x225/c/o/contribute1.jpg	https://audio.tflat.vn/audio/c/o/contribute.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	5
609	loyal	Adjective	Trung thành, trung nghĩa, trung kiên	/'lɔiəl/	remaining faithful to somebody / something and supporting them or it	Even though your assistant is loyal, you have to question his job performance.	Dù là trợ lý của anh trung thành, anh vẫn phải đặt vấn đề về kết quả công việc của hắn.	https://audio.tflat.vn/data/cache/images/300x225/l/o/loyal1.png	https://audio.tflat.vn/audio/l/o/loyal.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	2
612	productive	Adjective	Có năng suất, hiệu quả 	/prəˈdʌktɪv/	making goods or growing crops, especially in large quantities	The managers had a very productive meeting and were able to solve many of the problems.	Người trưởng phòng có một cuộc họp rất hiệu quả và đã có thể làm sáng tỏ nhiều vấn đề.	https://audio.tflat.vn/data/cache/images/300x225/p/r/productive1.png	https://audio.tflat.vn/audio/p/r/productive.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	5
611	obviously	Adverb	‹một cách› rõ ràng, hiển nhiên (clearly, evidently)	/ˈɒbviəsli/	used when giving infor that you expect other people to know already	Her tardiness was obviously resented by her coworkers.	Sự chậm chạp của cô ta rõ ràng là bị đồng nghiệp bực bội.	https://audio.tflat.vn/data/cache/images/300x225/o/b/obviously1.jpg	https://audio.tflat.vn/audio/o/b/obviously.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	1
607	look forward to	\N	Mong đợi, mong chờ, trông mong	\N	to anticipate	My mother look forward to seeing me after the war is over.	Mẹ tôi mong đợi được gặp tôi sau khi chiến tranh kết thúc. 	https://audio.tflat.vn/data/cache/images/300x225/l/o/look_forward_to1.jpg	https://audio.tflat.vn/audio/l/o/look_forward_to.mp3	Promotions, Pensions & Awards	https://tienganhtflat.com/blog/toeic-words-promotions-pensions-award	2026-07-24 17:22:34.132489	1
...
496	check-in	Noun	Sự nhận phòng	//	\N	Do you know your check-in time ?	Bạn có biết thời gian nhận phòng không?	https://audio.tflat.vn/data/cache/images/300x225/c/h/check-in2.jpg	https://audio.tflat.vn/audio/c/h/check-in.mp3	Hotels	https://tienganhtflat.com/blog/toeic-words-hotels	2026-07-24 17:22:34.132489	4
...
SELECT pg_catalog.setval('public."UserProfile_id_seq"', 11, true);
...
--
-- Name: grammar_categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.grammar_categories_id_seq', 99, true);


--
-- Name: grammar_lessons_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.grammar_lessons_id_seq', 243, true);


--
-- Name: listening_lessons_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.listening_lessons_id_seq', 1, false);
...
--
-- Name: reading_lessons_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.reading_lessons_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.user_grammar_progress_id_seq', 1, false);


--
-- Name: user_listening_progress_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.user_listening_progress_id_seq', 1, false);


--
-- Name: user_reading_progress_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.user_vocabulary_progress_id_seq', 61, true);
...
--
-- Name: grammar_categories grammar_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.grammar_categories
    ADD CONSTRAINT grammar_categories_pkey PRIMARY KEY (id);


--
-- Name: grammar_lessons grammar_lessons_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: listening_lessons listening_lessons_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reading_lessons reading_lessons_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reading_lessons
    ADD CONSTRAINT reading_lessons_pkey PRIMARY KEY (id);
...
--
-- Name: user_grammar_progress uq_user_grammar; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_grammar_progress
    ADD CONSTRAINT uq_user_grammar UNIQUE (user_id, lesson_id);


--
-- Name: user_listening_progress uq_user_listening; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_listening_progress
    ADD CONSTRAINT uq_user_listening UNIQUE (user_id, lesson_id);


--
-- Name: user_reading_progress uq_user_reading; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_reading_progress
    ADD CONSTRAINT uq_user_reading UNIQUE (user_id, lesson_id);
...
--
-- Name: user_listening_progress user_listening_progress_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_listening_progress
    ADD CONSTRAINT user_listening_progress_pkey PRIMARY KEY (id);


--
-- Name: user_reading_progress user_reading_progress_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: grammar_lessons fk_grammar_category; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.grammar_lessons
    ADD CONSTRAINT fk_grammar_category FOREIGN KEY (category_id) REFERENCES public.grammar_categories(id) ON DELETE CASCADE;


--
-- Name: user_grammar_progress fk_grammar_lesson; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_grammar_progress
    ADD CONSTRAINT fk_grammar_lesson FOREIGN KEY (lesson_id) REFERENCES public.grammar_lessons(id) ON DELETE CASCADE;


--
-- Name: grammar_lessons fk_grammar_test; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.grammar_lessons
    ADD CONSTRAINT fk_grammar_test FOREIGN KEY (test_id) REFERENCES public.tests(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: user_grammar_progress fk_grammar_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_grammar_progress
    ADD CONSTRAINT fk_grammar_user FOREIGN KEY (user_id) REFERENCES public."User"(id) ON DELETE CASCADE;


--
-- Name: user_listening_progress fk_listening_lesson; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_listening_progress
    ADD CONSTRAINT fk_listening_lesson FOREIGN KEY (lesson_id) REFERENCES public.listening_lessons(id) ON DELETE CASCADE;


--
-- Name: listening_lessons fk_listening_question_group; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.listening_lessons
    ADD CONSTRAINT fk_listening_question_group FOREIGN KEY (question_group_id) REFERENCES public.question_groups(id) ON DELETE CASCADE;


--
-- Name: user_listening_progress fk_listening_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_listening_progress
    ADD CONSTRAINT fk_listening_user FOREIGN KEY (user_id) REFERENCES public."User"(id) ON DELETE CASCADE;


--
-- Name: user_reading_progress fk_reading_lesson; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_reading_progress
    ADD CONSTRAINT fk_reading_lesson FOREIGN KEY (lesson_id) REFERENCES public.reading_lessons(id) ON DELETE CASCADE;


--
-- Name: reading_lessons fk_reading_question_group; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reading_lessons
    ADD CONSTRAINT fk_reading_question_group FOREIGN KEY (question_group_id) REFERENCES public.question_groups(id) ON DELETE CASCADE;


--
-- Name: user_reading_progress fk_reading_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_reading_progress
    ADD CONSTRAINT fk_reading_user FOREIGN KEY (user_id) REFERENCES public."User"(id) ON DELETE CASCADE;
...
\unrestrict wlhZPVVUlR5jt35wY9NV2mQ7Eh7kAkA2hs5TH1obNyUGweCleddHe12EhVvV3xc
